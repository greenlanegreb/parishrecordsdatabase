...
// Flash messages (same pattern as require_admin_page)
...
// Filter suggestions based on table-specific moderation permissions
$pending_suggestions = [];
...
// If the user has zero moderation permissions across any table, block access
