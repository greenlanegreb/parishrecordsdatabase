...
// Enforce dynamic permission check (automatically registers 'manage_moderation' if new)
require_permission($pdo, 'manage_moderation', 'Manage and review user correction suggestions and moderation queues');
