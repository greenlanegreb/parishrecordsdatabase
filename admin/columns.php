...
// Enforce dynamic permission check (automatically registers 'manage_columns' if new)
require_permission($pdo, 'manage_columns', 'Manage dynamic table columns and schema definitions');
