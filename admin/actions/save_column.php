<?php
// admin/actions/save_column.php - Handles column creation, updating, batch reordering, and deletion logic
...
// Verify CSRF and enforce dynamic permission check
verify_csrf_token();
$current_user = require_permission($pdo, 'manage_columns', 'Manage dynamic table columns and schema definitions');
...
// Redirect back to clean columns.php (omitting any ?edit= parameter so it collapses)
