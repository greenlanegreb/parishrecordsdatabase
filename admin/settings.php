...
<div class="search-box-container" role="region" aria-label="Site Settings Form" style="max-width: 800px; margin: 0 auto;">
    <h3>Global Site Settings & Notices</h3>
    <p>Manage core configurations, mail drivers, server health, maintenance mode, and application announcements.</p>
    ...
    <div role="tabpanel" id="panel-core" aria-labelledby="tab-core" class="tab-panel">
        <form method="POST" action="actions/save_settings.php">
            ...
            <!-- SMTP Configuration Block (Toggled via JS) -->
                        ...
                        <div style="margin-top: 1rem; padding-top: 1rem; border-top: 1px solid #eee;">
                            <form method="POST" action="actions/save_notice_inline.php">
                                ...
                                <div style="display: flex; gap: 1rem; flex-wrap: wrap; margin-bottom: 0.75rem; background: rgba(0,0,0,0.01); padding: 0.5rem; border: 1px solid #eee; border-radius: 4px;">
                                    ...
                                    <label style="font-weight: normal; font-size: 0.85rem; cursor: pointer;">
                                        <input type="checkbox" name="target_roles[]" value="public" class="role-checkbox-<?php echo $n['id']; ?>" <?php echo ($is_everyone || in_array('public', $selected_roles)) ? 'checked' : ''; ?> <?php echo $is_everyone ? 'disabled style="opacity:0.6;"' : ''; ?>> Public (Guests)
                                    </label>
                                    <label style="font-weight: normal; font-size: 0.85rem; cursor: pointer;">
