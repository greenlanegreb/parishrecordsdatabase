...
--
-- Host: localhost
-- Generation Time: Jul 24, 2026 at 12:26 AM
...
(2, 'somename', 'someuseremail@email.com', 'Nice!!', '2026-07-23 16:39:48', 'Pending', NULL);
...
INSERT INTO `table_columns` (`id`, `column_name`, `data_type`, `max_length`, `is_required`, `created_by`, `created_at`, `boolean_display_format`, `sort_order`, `updated_at`, `date_search_behavior`) VALUES
(1, 'Surname', 'VARCHAR', 20, 1, 1, '2026-07-23 13:25:04', NULL, 3, '2026-07-23 21:27:33', 'manual_only'),
(2, 'First Name', 'VARCHAR', 20, 1, 1, '2026-07-23 13:26:08', NULL, 4, '2026-07-23 21:27:41', 'manual_only'),
(3, 'Middle Name(s)', 'VARCHAR', 20, 0, 1, '2026-07-23 13:26:46', 'yes_no', 5, '2026-07-23 21:28:26', 'manual_only'),
(4, 'Date of Birth', 'DATE', 10, 0, 1, '2026-07-23 13:27:53', NULL, 8, '2026-07-23 21:28:48', 'manual_only'),
(5, 'Baptism Date', 'DATE', 10, 1, 1, '2026-07-23 13:28:39', NULL, 1, '2026-07-23 21:27:06', 'manual_only'),
(7, 'Location of Baptism', 'TEXT', 70, 1, 1, '2026-07-23 13:31:00', NULL, 2, '2026-07-23 21:27:24', 'manual_only'),
(8, 'Father\'s Name', 'VARCHAR', 20, 0, 1, '2026-07-23 13:32:31', 'yes_no', 6, '2026-07-23 21:28:37', 'manual_only'),
(9, 'Mother\'s Name', 'VARCHAR', 20, 0, 1, '2026-07-23 13:32:47', 'yes_no', 7, '2026-07-23 21:28:42', 'manual_only'),
(13, 'Sex', 'BOOLEAN', 7, 1, 1, '2026-07-23 22:07:37', 'male_female', 0, '2026-07-23 23:46:02', NULL);
...
INSERT INTO `users` (`id`, `username`, `first_name`, `surname`, `leaderboard_display_mode`, `email`, `password_hash`, `role`, `points`, `is_active`, `email_verified`, `verification_token`, `token_expires_at`, `google_2fa_secret`, `two_fa_enabled`, `created_at`, `backup_codes`, `timezone`, `date_format`, `time_format`) VALUES
(1, 'username', 'firstname', 'surname', 'initials_random', 'email@email.com', 'hashed_password', 'admin', 0, 1, 1, NULL, NULL, NULL, 0, '2026-07-22 16:00:55', NULL, 'Europe/London', 'd/m/Y', '24');
