                    ...
                    <?php foreach ($columns as $col): ?>
                        ...
                        <tr data-column-id="<?= $colId ?>" style="cursor: grab;">
                            ...
                            <td class="text-end pe-3 text-nowrap">
                                <a href="<?= $basePath ?>/admin/tables?table_id=<?= $activeTableId ?>&edit_column=<?= $colId ?>#create-column-details" class="btn btn-sm btn-outline-secondary me-1"><?= htmlspecialchars(__('feedback_schema.edit_btn'), ENT_QUOTES, 'UTF-8') ?></a>
