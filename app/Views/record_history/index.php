...
<div class="container my-4" style="max-width: 900px;">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 class="h4 fw-bold text-dark mb-0"><?= htmlspecialchars(__('record_history.heading_prefix'), ENT_QUOTES, 'UTF-8') ?> #<?= $recordId ?></h3>
    ...
    <p class="text-muted small mb-4">
        <?= htmlspecialchars(__('record_history.directory_table_label'), ENT_QUOTES, 'UTF-8') ?> <strong class="text-dark"><?= htmlspecialchars($record['table_name'], ENT_QUOTES, 'UTF-8') ?></strong><br>
            ...
            <?php foreach ($historyLogs as $log): ?>
                ...
                <div class="card border-0 shadow-sm p-3 border-start border-primary border-4 bg-white">
                    ...
                    <div class="small text-secondary mb-2">
                        <strong><?= htmlspecialchars(__('record_history.actor_label'), ENT_QUOTES, 'UTF-8') ?></strong> <?= htmlspecialchars($username, ENT_QUOTES, 'UTF-8') ?>
                    </div>
