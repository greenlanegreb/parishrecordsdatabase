...
// Enforce dynamic permission check replacing hardcoded roles (automatically registers 'setup_2fa' if new)
...
verify_csrf_token();
$current_user = require_permission($pdo, 'setup_2fa', 'Allows setting up and configuring Google Authenticator 2FA');
