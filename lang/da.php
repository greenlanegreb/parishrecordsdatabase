...
return [
    ...
    'nav.zoom_group'                              => 'Tekststørrelse',
    'nav.zoom_in'                                 => 'Større tekst',
    'nav.zoom_out'                                => 'Mindre tekst',
    'nav.zoom_reset'                              => 'Nulstil tekststørrelse',
    ...
    'index.no_public_tables'                      => 'Der er ingen tabeller tilgængelige for offentligheden på dette websted.',
    'record.back'                                 => 'Tilbage til listen',
    'record.heading'                              => 'Post',
    'record.print'                                => 'Udskriv denne post',
    'record.view'                                 => 'Vis post',
    ...
    // ------------------------------------------------------------------
    'index.admin_add_columns_guide'               => 'Som administrator bedes du gå til Administration → Administrer tabeller for at tilføje mindst én kolonne til din tabel.',
    'index.admin_create_table_guide'              => 'Som administrator bedes du gå til Administration → Administrer tabeller for at oprette en tabel og derefter tilføje mindst én kolonne til tabellen, før poster kan ses eller indtastes.',
    ...
    'index.guest_login_tables_guide'              => 'Log venligst ind som administrator og gå til Administration → Administrer tabeller for at oprette en tabel og derefter tilføje mindst én kolonne.',
    ...
    'feedback_dash.th_ticket_date'                => 'Dato',
    ...
    'manage_tables.edit_metadata_btn'             => 'Rediger tabeldetaljer',
    ...
    'manage_tables.exclude_search_label'          => 'Udelad denne kolonne fra offentlig søgning',
    'manage_tables.existing_cols_heading_prefix'  => 'Eksisterende kolonner for',
    'manage_tables.heading'                       => 'Dynamisk tabel- og kolonnestyring',
    'manage_tables.intro'                         => 'Du kan ændre navne, felttyper og hvad der vises på søgelisterne eller den unikke postside her.',
    ...
    'manage_tables.req_toggle_label'              => 'Gør denne kolonne obligatorisk (obligatorisk dataindtastning)',
    'manage_tables.save_and_add_col'              => 'Gem og tilføj en til',
    'manage_tables.save_table_btn'                => 'Gem tabelændringer',
    'manage_tables.show_in_list'                  => 'Vis på søge- / dataindtastningslisten',
    'manage_tables.show_in_record'                => 'Vis på hele post-siden',
    'manage_tables.status_hidden'                 => 'Skjult',
    'manage_tables.subheading'                    => 'Du kan ændre navne, felttyper og hvad der vises på søgelisten eller den unikke postside.',
    ...
    'manage_tables.type_boolean'                  => 'Boolsk (Mand / Kvinde, Tjek / Kryds, Sand / Falsk, Ja / Nej)',
    'manage_tables.type_choice'                   => 'Valgliste',
    'manage_tables.type_date'                     => 'Dato',
    'manage_tables.type_email'                    => 'E-mailadresse',
    'manage_tables.type_int'                      => 'Heltal',
    'manage_tables.type_location'                 => 'Placering (Kortnål)',
    ...
    'manage_tables.type_text_long'                => 'Lang tekst',
    'manage_tables.type_time'                     => 'Tid',
    'manage_tables.type_url'                      => 'Webadresse',
    'manage_tables.type_varchar'                  => 'Kort tekst',
    'manage_tables.url_new_tab'                   => 'Åbn i en ny fane',
    ...
    'user_emails.desc_outcome'                    => 'Dette sendes, når en moderator accepterer eller afviser en foreslået redigering, og indsenderen bad om at få en e-mail.',
    ...
    'user_emails.placeholders_hint'               => 'Disse tokens udfyldes, når denne skabelon sendes. Kun kortene nedenfor gælder for den skabelon, du har valgt.',
    ...
    // ------------------------------------------------------------------
    'appearance.add_link'                         => 'Tilføj et link',
    'appearance.brand_heading'                    => 'Logo og slogan',
    'appearance.colors_heading'                   => 'Farver',
    'appearance.colors_help'                      => 'Høj kontrast tilsidesætter altid disse, når nogen bruger den skifter.',
    'appearance.custom_heading'                   => 'Brugerdefinerede links',
    'appearance.custom_help'                      => 'Tilføj venligst så mange du har brug for. Indstil overordnede (parent) for at indlejre et link under en anden overskrift eller under en indbygget menu såsom Administration. Brug venligst # som adresse for en overskrift, der kun er en titel.',
    'appearance.custom_label'                     => 'Etiket',
    'appearance.custom_parent'                    => 'Overordnet',
    'appearance.custom_url'                       => 'Adresse',
    'appearance.custom_who'                       => 'Hvem kan se det',
    'appearance.drag'                             => 'Træk venligst for at ændre rækkefølgen',
    'appearance.nav_heading'                      => 'Navigation',
    'appearance.nav_help'                         => 'Du kan trække i håndtaget for at ændre rækkefølgen på indbyggede og brugerdefinerede links sammen. For at placere et link under Administration (eller en anden overskrift), skal du indstille den overordnede for det link. Adressen # opretter en overskrift uden sin egen side. Login og profil forbliver i deres indbyggede position.',
    'appearance.new_tab'                          => 'Ny fane',
    'appearance.parent_builtin'                   => 'Indbyggede menuer',
    'appearance.parent_custom'                    => 'Dine overskrifter',
    'appearance.parent_none'                      => 'Topniveau — Eget menupunkt',
    'appearance.remove_link'                      => 'Fjern',
    'appearance.reset'                            => 'Nulstil til standard',
    'appearance.reset_ok'                         => 'Udseende nulstillet til standardudseendet.',
    'appearance.save'                             => 'Gem udseende',
    'appearance.saved'                            => 'Udseende gemt.',
    ...
    'settings.cron_command_label'                 => 'Her er kommandoen, der skal indsættes i dine cron-jobs (en gang om dagen passer perfekt!)',
    'settings.cron_exec_ok'                       => 'Denne side fik tilladelse til at teste PHP herfra (valgfrit)',
    'settings.cron_maintenance_desc'              => 'pRD har automatisk set på din webserver og foreslår en natlig kommando. Du skal stadig indsætte den i dine cron-jobs. Du kan også køre en oprydning nu.',
    'settings.cron_maintenance_heading'           => 'Automatisk token-vedligeholdelse og Cron-opsætning',
    'settings.cron_php_ok'                        => 'PHP-kommando fundet',
    'settings.cron_script_ok'                     => 'Tillykke - Dit oprydningsscript er på plads!',
    ...
    'settings.map_tile_api_key_help'              => 'Dette er nødvendigt for CARTO, Mapbox eller Stadia. Lad det være tomt for at beholde en eksisterende nøgle. Standard OpenStreetMap behøver ikke en nøgle.',
    'settings.map_tile_carto'                     => 'CARTO Voyager (Gratis nøgle tilgængelig fra carto.com/basemaps/apikey)',
    'settings.map_tile_custom'                    => 'Brugerdefineret tile-URL',
    'settings.map_tile_default'                   => 'Standard gratis (OpenStreetMap)',
    ...
    'settings.mod_leaderboard_desc'               => 'Anerkender transskriptionsindsats og holder regnskab.',
    'settings.mod_leaderboard_note'               => '(Kræver brugeradministration og flerbrugeradgang)',
    'settings.mod_maps'                           => 'Kort',
    'settings.mod_maps_desc'                      => 'Vis et geografisk kort for hver tabel, der har en dynamisk lokationskolonne.',
    ...
    'settings.perm_save_failed'                   => 'Beklager - pRD kunne ikke gemme denne indstilling.',
    'settings.perm_saved'                         => 'Gemt',
    'settings.perm_swipe'                         => 'På en lille skærm bedes du swipe denne liste til siden, hvis det er nødvendigt.',
    ...
    'settings.subheading'                         => 'Administrer udseende, kernekonfiguration, mail-drivere, sikkerheds-/CAPTCHA-indstillinger, moduler, vedligeholdelsestilstand, webstedsmeddelelser og rollekapaciteter.',
    ...
    'update_database.emergency_active'            => 'Databaseopdateringsadgang er åben, så du kan afslutte dette trin uden at logge ind. Den lukker af sig selv, når databasen er opdateret.',
    'updates.already_current'                     => 'Filerne matcher allerede den valgte opdateringskanal. Intet blev ændret.',
    'updates.apply_btn'                           => 'Anvend filpakke',
    'updates.archive_failed'                      => 'Beklager - pRD kunne ikke skrive den private databasekopi. Filopdatering blev ikke startet.',
    'updates.archive_missing'                     => 'Beklager - den private backup blev ikke fundet.',
    'updates.channel_help'                        => 'Undlad venligst at ændre opdateringskanalen, medmindre du er udvikler. Udviklere kan placere et tag eller en commit-reference i denne boks.',
    'updates.channel_label'                       => 'Opdateringskanal (dette bør normalt efterlades som "Main")',
    'updates.channel_saved'                       => 'Opdateringskanal gemt.',
    'updates.confirm'                             => 'Vil du anvende filpakken nu? Stille og roligt, dine poster forbliver. Download venligst en kopi af din database først, hvis du ikke allerede har gjort det.',
    'updates.db_behind'                           => 'Database: En opdatering venter',
    'updates.db_pending'                          => 'Hvis pRD beder dig om at opdatere databasen næste gang, bedes du åbne den side. Du behøver ikke at oprette nogen ekstra filer.',
    'updates.db_ran'                              => 'Databasen blev også opdateret.',
    'updates.download_heading'                    => 'Downloader din database..',
    'updates.download_please'                     => 'Download venligst din database først. Behold venligst din egen kopi så vel som den private serverkopi.',
    'updates.files_behind'                        => 'Filer: En nyere pakke er tilgængelig',
    'updates.files_current'                       => 'Filer: Opdateret med den valgte opdateringskanal',
    'updates.files_error'                         => 'Filer: Beklager, pRD kunne ikke tjekke GitHub lige nu. Prøv igen senere.',
    'updates.files_ok'                            => 'Tillykke! Filpakke anvendt.',
    'updates.files_unknown'                       => 'Filer: Ikke tjekket endnu (anvend venligst en pakke én gang for at starte sporing)',
    'updates.force_apply'                         => 'Erstat filer alligevel (kun hvis noget ser beskadiget ud)',
    'updates.heading'                             => 'Filopdateringer',
    'updates.help'                                => 'Download venligst din database først. pRD beholder også en privat kopi på serveren. Filopdatering ændrer ikke poster. Når filer er opdateret, bedes du bruge "Opdater database", hvis en nyere databaseversion venter.',
    'updates.no_sha'                              => 'Ingen pakke registreret endnu',
    'updates.now_db'                              => 'Hvis databaseversionen er bagud, bedes du bruge "Opdater database" bagefter.',
    'updates.page_heading'                        => 'Opdatering af pRD',
    'updates.private_copies'                      => 'Private serverkopier (kun for administratorer)',
    'updates.running'                             => 'Dette websted kører',
    ...
    'admin_users.not_verified_badge'              => 'Ikke verificeret',
    ...
    'admin_users.reset_2fa_btn'                   => 'Slå 2FA fra',
    ...
    'admin_users.verified_badge'                  => 'Verificeret',
    ...
    'install.admin_subheading'                    => 'Dette er loginoplysningerne til denne hjemmeside (ikke databasen).',
    'install.admin_username_label'                => 'Administratorbrugernavn',
    'install.back_btn'                            => 'Tilbage',
    'install.close_alert'                         => 'Luk',
    'install.complete_desc'                       => 'Din pRD-installation er nu sat op, og installationsprogrammet er låst, så det ikke kan køres igen ved en fejltagelse.',
    'install.complete_heading'                    => 'Tillykke!',
    'install.complete_title'                      => 'Installation fuldført',
    'install.continue_btn'                        => 'Fortsæt',
    'install.db_heading'                          => 'Databaseforbindelse',
    'install.db_hint'                             => 'Brug venligst MySQL-oplysningerne fra dit webhotel/kontrolpanel. Dette er ikke administrator-loginet til hjemmesiden (det kommer bagefter).',
    ...
    'install.delete_folder_hint'                  => 'Mange webhosts tillader ikke installationsprogrammet at slette sin egen mappe. Hvis knappen ikke gør noget, bedes du åbne din webshostings filhåndtering eller FTP, gå til din pRD-projektmappe og slette eller omdøbe installationsmappen der.',
    ...
    'install.mod_feedback'                        => 'Feedbackindsendelser',
    'install.mod_feedback_desc'                   => 'Aktiverer en offentlig feedbackformular og et admin-sporingsdashboard.',
    'install.mod_leaderboard'                     => 'Rangliste & gamification',
    ...
    'install.mod_moderation'                      => 'Moderationsworkflow',
    'install.mod_moderation_desc'                 => 'Et moderationsworkflow-system, der giver brugere mulighed for at foreslå redigeringer, og en moderator mulighed for at godkende eller afvise forslaget.',
    'install.mod_users'                           => 'Brugerstyring & flerbrugersikkerhed',
    'install.mod_users_desc'                      => 'Lad folk registrere sig og logge ind.',
    'install.mod_volunteers'                      => 'Frivilligportal & indsendelser',
    'install.mod_volunteers_desc'                 => 'Aktiverer en offentlig formular for frivilliginteresse og et admin-styringsdashboard.',
    ...
    'install.modules_later'                       => 'Du kan slå hvilken som helst af disse moduler til eller fra senere under Admin → Webstedsindstillinger.',
    ...
    'install.msg_modules_saved'                   => 'Dine modulvalg er blevet gemt. Du kan tilføje valgfrie demopakker eller springe dette trin over, hvis du foretrækker det.',
    ...
    'install.remove_already_gone'                 => 'Installationsmappen er allerede fjernet.',
    'install.remove_failed'                       => 'Beklager - pRD kunne ikke slette installationsmappen automatisk (webservere kan ofte ikke). Åbn pRD-mappen i din webshostings filhåndtering eller via FTP, og slet eller omdøb installationsmappen indeni.',
    'install.remove_folder_btn'                   => 'Fjern venligst installationsmappen!',
    'install.remove_ok'                           => 'Installationsmappen er blevet fjernet.',
    ...
    'save_data_entry.err_email'                   => 'Indtast venligst en gyldig e-mail for %s.',
    ...
    'save_data_entry.err_url'                     => 'Indtast venligst en webadresse, der starter med http:// eller https:// for %s.',
    ...
    'data_entry.admin_cols_prompt'                => 'Hvis du er administrator, bedes du gå til Administration → Administrer tabeller for at administrere kolonner og tilføje mindst én kolonne til denne tabel.',
    'data_entry.admin_tables_prompt'              => 'Hvis du er administrator, bedes du gå til Administration → Administrer tabeller for at tilføje en tabel og derefter tilføje mindst én kolonne.',
    ...
    'data_entry.date_format_hint'                 => 'Brug venligst det datoformat, der vises i feltet.',
    ...
    'data_entry.go_manage_tables'                 => 'Gå venligst til Administration → Administrer tabeller',
    ...
    'data_entry.shortcuts_tip'                    => '💡 Tip: Tryk på Ctrl + Enter for at indsende, eller Esc for at rydde det aktuelle felt.',
    'data_entry.submit_data_btn'                  => 'Indsend data',
    'data_entry.th_added_by'                      => 'Tilføjet af',
    'data_entry.th_date_created'                  => 'Oprettet dato',
    'data_entry.time_format_hint'                 => 'Brug venligst det tidsformat, der vises i feltet.',
    ...
    'profile.setup_tfa_btn'                       => 'Opsæt 2FA',
    ...
    'setup_2fa.backup_desc'                       => 'Gem venligst disse backup-koder et sikkert sted. Hver kode kan bruges én gang, hvis du mister adgangen til din 2FA-app:',
