...
return [
    ...
    'nav.zoom_group'                              => 'Tamanho do texto',
    'nav.zoom_in'                                 => 'Texto maior',
    'nav.zoom_out'                                => 'Texto menor',
    'nav.zoom_reset'                              => 'Repor tamanho do texto',
    ...
    'index.no_public_tables'                      => 'Não existem tabelas disponíveis para o público neste site.',
    'record.back'                                 => 'Voltar à lista',
    'record.heading'                              => 'Registo',
    'record.print'                                => 'Imprimir este registo',
    'record.view'                                 => 'Ver registo',
    ...
    'manage_tables.edit_metadata_btn'             => 'Editar detalhes da tabela',
    ...
    'manage_tables.exclude_search_label'          => 'Excluir esta coluna da pesquisa pública',
    'manage_tables.existing_cols_heading_prefix'  => 'Colunas existentes para',
    'manage_tables.heading'                       => 'Gestão dinâmica de tabelas e colunas',
    'manage_tables.intro'                         => 'Aqui pode alterar os nomes, os tipos de campos e o que aparece nas listas de pesquisa ou na página de registo único.',
    ...
    'manage_tables.req_toggle_label'              => 'Tornar esta coluna obrigatória (introdução de dados obrigatória)',
    'manage_tables.save_and_add_col'              => 'Guardar e adicionar outra',
    'manage_tables.save_table_btn'                => 'Guardar alterações da tabela',
    'manage_tables.show_in_list'                  => 'Mostrar na lista de pesquisa / introdução de dados',
    'manage_tables.show_in_record'                => 'Mostrar na página de registo completo',
    'manage_tables.status_hidden'                 => 'Oculto',
    'manage_tables.subheading'                    => 'Pode alterar os nomes, os tipos de campos e o que aparece na lista de pesquisa ou na página de registo único.',
    ...
    'manage_tables.type_boolean'                  => 'Booleano (Masculino / Feminino, Marca / Cruz, Verdadeiro / Falso, Sim / Não)',
    'manage_tables.type_choice'                   => 'Lista de escolhas',
    'manage_tables.type_date'                     => 'Data',
    'manage_tables.type_email'                    => 'Endereço de e-mail',
    'manage_tables.type_int'                      => 'Inteiro (Número inteiro)',
    ...
    'manage_tables.type_text_long'                => 'Texto longo',
    'manage_tables.type_time'                     => 'Hora',
    'manage_tables.type_url'                      => 'Endereço web',
    'manage_tables.type_varchar'                  => 'Texto curto',
    'manage_tables.url_new_tab'                   => 'Abrir em um novo separador',
    ...
    'user_emails.desc_outcome'                    => 'Isto é enviado quando um moderador aceita ou rejeita uma edição sugerida e o remetente pediu para receber um e-mail.',
    ...
    'user_emails.placeholders_hint'               => 'Estes marcadores são preenchidos quando este modelo é enviado. Apenas os cartões abaixo se aplicam ao modelo que selecionou.',
    ...
    // ------------------------------------------------------------------
    'appearance.add_link'                         => 'Adicionar um link',
    'appearance.brand_heading'                    => 'Logótipo e slogan',
    'appearance.colors_heading'                   => 'Cores',
    'appearance.colors_help'                      => 'O alto contraste substitui sempre estas definições quando alguém utiliza esse interruptor.',
    'appearance.custom_heading'                   => 'Links personalizados',
    'appearance.custom_help'                      => 'Sinta-se à vontade para adicionar quantos precisar. Defina o elemento principal para aninhar um link sob outro cabeçalho ou sob um menu integrado como Admin. Utilize # como endereço para um cabeçalho que seja apenas um título.',
    'appearance.custom_label'                     => 'Etiqueta',
    'appearance.custom_parent'                    => 'Principal',
    'appearance.custom_url'                       => 'Endereço',
    'appearance.custom_who'                       => 'Quem pode ver',
    'appearance.drag'                             => 'Arraste para reordenar, por favor',
    'appearance.nav_heading'                      => 'Navegação',
    'appearance.nav_help'                         => 'Pode arrastar a pega para reordenar os links integrados e personalizados em conjunto. Para colocar um link sob Admin (ou outro cabeçalho), defina o elemento principal nesse link. O endereço # cria um cabeçalho sem página própria. O início de sessão e o perfil permanecem na respetiva posição integrada.',
    'appearance.new_tab'                          => 'Novo separador',
    'appearance.parent_builtin'                   => 'Menus integrados',
    'appearance.parent_custom'                    => 'Os seus cabeçalhos',
    'appearance.parent_none'                      => 'Nível superior — Item de menu próprio',
    'appearance.remove_link'                      => 'Remover',
    'appearance.reset'                            => 'Repor predefinições',
    'appearance.reset_ok'                         => 'Aspeto reposto para o visual predefinido.',
    'appearance.save'                             => 'Guardar aspeto',
    'appearance.saved'                            => 'Aspeto guardado.',
    'appearance.type_heading'                     => 'Tipo',
    'no_sha'                                      => 'Nenhum pacote registado ainda',
    ...
    'settings.cron_command_label'                 => 'Aqui tem o comando para colar nas suas tarefas Cron (Uma vez por dia é o ideal!)',
    'settings.cron_exec_ok'                       => 'Esta página teve permissão para testar PHP a partir daqui (opcional)',
    'settings.cron_maintenance_desc'              => 'O pRD analisou automaticamente o seu servidor web e sugere um comando noturno. Ainda precisa de o colar nas suas tarefas Cron. Também pode executar uma limpeza agora.',
    ...
    'settings.cron_script_ok'                     => 'Parabéns - O seu script de limpeza está no sítio certo!',
    ...
    'settings.map_tile_api_key_help'              => 'Isto é necessário para CARTO, Mapbox ou Stadia. Deixe em branco para manter uma chave existente. O OpenStreetMap predefinido não necessita de chave.',
    'settings.map_tile_carto'                     => 'CARTO Voyager (Chave gratuita disponível em carto.com/basemaps/apikey)',
    'settings.map_tile_custom'                    => 'URL de mosaico personalizado',
    'settings.map_tile_default'                   => 'Predefinição gratuita (OpenStreetMap)',
    ...
    'settings.mod_leaderboard_desc'               => 'Reconhece os esforços de transcrição e mantém a pontuação.',
    'settings.mod_leaderboard_note'               => '(Requer gestão de utilizadores e acesso multiutilizador)',
    'settings.mod_maps'                           => 'Mapas',
    'settings.mod_maps_desc'                      => 'Mostra um mapa geográfico para cada tabela que possua uma coluna de localização dinâmica.',
    ...
    'settings.perm_save_failed'                   => 'Desculpe - o pRD não conseguiu guardar esta definição.',
    'settings.perm_saved'                         => 'Guardado',
    'settings.perm_swipe'                         => 'Num ecrã pequeno, desloque esta lista para os lados, se necessário.',
    ...
    'settings.subheading'                         => 'Gerir aspeto, configuração principal, controladores de correio, opções de segurança/CAPTCHA, módulos, modo de manutenção, anúncios do site e permissões de funções.',
    'settings.sys_name_label'                     => 'Nome do sistema / aplicação:',
    'settings.system_guest'                       => 'Sistema / Convidado',
    'settings.tab_appearance'                     => 'Aspeto',
    ...
    'update_database.emergency_active'            => 'O acesso à atualização da base de dados está aberto para que possa concluir este passo sem iniciar sessão. Fechar-se-á automaticamente quando a base de dados estiver atualizada.',
    'updates.already_current'                     => 'Os ficheiros já correspondem ao canal de atualização selecionado. Nada foi alterado.',
    'updates.apply_btn'                           => 'Aplicar pacote de ficheiros',
    'updates.archive_failed'                      => 'Desculpe - o pRD não conseguiu escrever a cópia privada da base de dados. A atualização de ficheiros não foi iniciada.',
    'updates.archive_missing'                     => 'Desculpe - essa cópia de segurança privada não foi encontrada.',
    'updates.channel_help'                        => 'Não altere o canal de atualização, a menos que seja um programador. Os programadores podem colocar uma etiqueta ou uma referência de commit nesta caixa.',
    'updates.channel_label'                       => 'Canal de atualização (normalmente deve ser deixado como "Main")',
    'updates.channel_saved'                       => 'Canal de atualização guardado.',
    'updates.confirm'                             => 'Pretende aplicar o pacote de ficheiros agora? Não se preocupe, os seus registos serão mantidos. Transfira primeiro uma cópia da sua base de dados, caso ainda não o tenha feito.',
    'updates.db_behind'                           => 'Base de dados: há uma atualização pendente',
    'updates.db_pending'                          => 'Se o pRD lhe pedir para atualizar a base de dados a seguir, abra essa página. Não precisa de criar quaisquer ficheiros adicionais.',
    'updates.db_ran'                              => 'A base de dados também foi atualizada.',
    'updates.download_heading'                    => 'A transferir a sua base de dados..',
    'updates.download_please'                     => 'Transfira primeiro a sua base de dados. Conserve a sua própria cópia, bem como a cópia privada do servidor.',
    'updates.files_behind'                        => 'Ficheiros: está disponível um pacote mais recente',
    'updates.files_current'                       => 'Ficheiros: atualizados com o canal de atualização selecionado',
    'updates.files_error'                         => 'Ficheiros: desculpe, o pRD não conseguiu verificar o GitHub neste momento. Tente novamente mais tarde.',
    'updates.files_ok'                            => 'Parabéns! Pacote de ficheiros aplicado.',
    'updates.files_unknown'                       => 'Ficheiros: ainda não verificados (aplique um pacote uma vez para iniciar o seguimento)',
    'updates.force_apply'                         => 'Substituir ficheiros mesmo assim (apenas se algo parecer danificado)',
    'updates.heading'                             => 'Atualizações de ficheiros',
    'updates.help'                                => 'Transfira primeiro a sua base de dados. O pRD também mantém uma cópia privada no servidor. A atualização de ficheiros não altera os registos. Após atualizar os ficheiros, utilize "Atualizar base de dados" se houver uma versão de base de dados mais recente pendente.',
    'updates.now_db'                              => 'Se a versão da base de dados estiver desatualizada, utilize "Atualizar base de dados" a seguir.',
    'updates.page_heading'                        => 'A atualizar o pRD',
    'updates.private_copies'                      => 'Cópias privadas do servidor (apenas administrador)',
    'updates.running'                             => 'Este site está em execução',
    ...
    'admin_users.not_verified_badge'              => 'Não verificado',
    ...
    'admin_users.reset_2fa_btn'                   => 'Desativar 2FA',
    ...
    'install.complete_desc'                       => 'A sua instalação do pRD está agora configurada e o instalador foi bloqueado para que não possa ser executado novamente por engano.',
    'install.complete_heading'                    => 'Parabéns!',
    ...
    'install.delete_folder_hint'                  => 'Muitos alojamentos web não permitem que o instalador elimine a sua própria pasta. Se o botão não fizer nada, abra o gestor de ficheiros do seu alojamento web ou FTP, aceda à pasta do projeto pRD e elimine ou mude o nome do diretório de instalação aí presente.',
    ...
    'install.mod_feedback'                        => 'Submissões de feedback',
    'install.mod_feedback_desc'                   => 'Ativa um formulário de feedback público e um painel de controlo de acompanhamento de administração.',
    'install.mod_leaderboard'                     => 'Tabela de classificação e gamificação',
    ...
    'install.mod_moderation'                      => 'Fluxo de trabalho de moderação',
    'install.mod_moderation_desc'                 => 'Um sistema de fluxo de trabalho de moderação que permite aos utilizadores sugerir edições e a um moderador aprovar ou rejeitar a sugestão.',
    'install.mod_users'                           => 'Gestão de utilizadores e acesso multiutilizador',
    'install.mod_users_desc'                      => 'Permitir que as pessoas se registem e iniciem sessão.',
    'install.mod_volunteers'                      => 'Portal de voluntários e submissões',
    'install.mod_volunteers_desc'                 => 'Ativa um formulário público de interesse de voluntariado e um painel de controlo de gestão de administração.',
    ...
    'install.modules_later'                       => 'Pode ativar ou desativar qualquer um destes módulos mais tarde em Admin → Definições do site.',
    ...
    'install.msg_modules_saved'                   => 'As suas escolhas de módulos foram guardadas. Pode adicionar pacotes de demonstração opcionais ou ignorar este passo, se preferir.',
    ...
    'install.remove_already_gone'                 => 'A pasta de instalação já tinha sido removida.',
    'install.remove_failed'                       => 'Desculpe - o pRD não conseguiu eliminar automaticamente a pasta de instalação (os servidores web muitas vezes não o permitem). No gestor de ficheiros do seu alojamento web ou através de FTP, abra a pasta pRD e elimine ou mude o nome do diretório de instalação no seu interior.',
    'install.remove_folder_btn'                   => 'Por favor, remova a pasta install!',
    'install.remove_ok'                           => 'A pasta de instalação foi removida.',
    ...
    'save_data_entry.err_email'                   => 'Por favor, insira um e-mail válido para %s.',
    ...
    'save_data_entry.err_url'                     => 'Por favor, insira um endereço web iniciado com http:// ou https:// para %s.',
    ...
    'data_entry.date_format_hint'                 => 'Utilize o formato de data apresentado na caixa.',
    ...
    'data_entry.time_format_hint'                 => 'Utilize o formato de hora apresentado na caixa.',
