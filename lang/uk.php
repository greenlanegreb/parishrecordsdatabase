...
return [
    ...
    'nav.zoom_group'                              => 'Розмір тексту',
    'nav.zoom_in'                                 => 'Більший текст',
    'nav.zoom_out'                                => 'Менший текст',
    'nav.zoom_reset'                              => 'Скинути розмір тексту',
    ...
    'index.no_public_tables'                      => 'На цьому сайті немає доступних для публіки таблиць.',
    'record.back'                                 => 'Назад до списку',
    'record.heading'                              => 'Запис',
    'record.print'                                => 'Друкувати цей запис',
    'record.view'                                 => 'Переглянути запис',
    ...
    'cols.back'                                   => 'Назад',
    'cols.print_btn'                              => 'Друк',
    'cols.print_entire'                           => 'Друкувати всі',
    'cols.print_filtered'                         => 'Друкувати відфильтровані',
    ...
    'manage_tables.edit_metadata_btn'             => 'Редагувати деталі таблиці',
    ...
    'manage_tables.exclude_search_label'          => 'Виключити цю колонку з публічного пошуку',
    'manage_tables.existing_cols_heading_prefix'  => 'Існуючі колонки для',
    'manage_tables.heading'                       => 'Динамічне управління таблицями та колонками',
    'manage_tables.intro'                         => 'Тут ви можете змінити назви, типи полів, а також те, що відображається в списках пошуку або на сторінці окремого запису.',
    ...
    'manage_tables.req_toggle_label'              => 'Зробити цю колонку обов’язковою (обов’язкове введення даних)',
    'manage_tables.save_and_add_col'              => 'Зберегти і додати інше',
    'manage_tables.save_table_btn'                => 'Зберегти зміни таблиці',
    'manage_tables.show_in_list'                  => 'Відображати в списку пошуку / введення даних',
    'manage_tables.show_in_record'                => 'Відображати на сторінці повного запису',
    'manage_tables.status_hidden'                 => 'Приховано',
    'manage_tables.subheading'                    => 'Ви можете змінити назви, типи полів, а також те, що відображається в списку пошуку або на сторінці окремого запису.',
    ...
    'manage_tables.type_boolean'                  => 'Логічне (Чоловіча / Жіноча, Галочка / Хрестик, Правда / Хибно, Так / Ні)',
    'manage_tables.type_choice'                   => 'Список вибору',
    'manage_tables.type_date'                     => 'Дата',
    'manage_tables.type_email'                    => 'Адреса електронної пошти',
    'manage_tables.type_int'                      => 'Ціле число (Integer)',
    ...
    'manage_tables.type_text_long'                => 'Довгий текст',
    'manage_tables.type_time'                     => 'Час',
    'manage_tables.type_url'                      => 'Веб-адреса',
    'manage_tables.type_varchar'                  => 'Короткий текст',
    'manage_tables.url_new_tab'                   => 'Відкрити у новій вкладці',
    ...
    'user_emails.desc_outcome'                    => 'Цей лист надсилається, коли модератор приймає або відхиляє запропоновану правку, а автор запитав отримання електронного листа.',
    ...
    'user_emails.placeholders_hint'               => 'Ці теги заповнюються під час надсилання цього шаблону. Лише наведені нижче картки застосовуються до вибраного вами шаблону.',
    ...
    // ------------------------------------------------------------------
    'appearance.add_link'                         => 'Додати посилання',
    'appearance.brand_heading'                    => 'Логотип та слоган',
    'appearance.colors_heading'                   => 'Кольори',
    'appearance.colors_help'                      => 'Високий контраст завжди переопитує ці налаштування, коли хтось використовує цей перемикач.',
    'appearance.custom_heading'                   => 'Користувацькі посилання',
    'appearance.custom_help'                      => 'Додавайте стільки, скільки вам потрібно. Встановіть батьківський елемент (parent), щоб вкласти посилання під інший заголовок або під вбудоване меню, наприклад Адмін. Будь ласка, використовуйте # як адресу для заголовка, який є просто назвою.',
    'appearance.custom_label'                     => 'Мітка',
    'appearance.custom_parent'                    => 'Батьківський елемент',
    'appearance.custom_url'                       => 'Адреса',
    'appearance.custom_who'                       => 'Хто може це бачити',
    'appearance.drag'                             => 'Будь ласка, перетягніть для зміни порядку',
    'appearance.nav_heading'                      => 'Навігація',
    'appearance.nav_help'                         => 'Ви можете перетягнути повзунок, щоб впорядкувати вбудовані та користувацькі посилання разом. Щоб розмістити посилання під Адміном (або іншим заголовком), встановіть батьківський елемент для цього посилання. Адреса # створює заголовок без власної сторінки. Вхід та профіль залишаються на своїх вбудованих позиціях.',
    'appearance.new_tab'                          => 'Нова вкладка',
    'appearance.parent_builtin'                   => 'Вбудовані меню',
    'appearance.parent_custom'                    => 'Ваші заголовки',
    'appearance.parent_none'                      => 'Верхній рівень — Власний пункт меню',
    'appearance.remove_link'                      => 'Видалити',
    'appearance.reset'                            => 'Скинути за замовчуванням',
    'appearance.reset_ok'                         => 'Вигляд скинуто до стандартного.',
    'appearance.save'                             => 'Зберегти вигляд',
    'appearance.saved'                            => 'Вигляд збережено.',
    'appearance.type_heading'                     => 'Тип',
    'no_sha'                                      => 'Ще не зареєстровано жодного пакета',
    ...
    'settings.cron_command_label'                 => 'Ось команда для вставлення у ваші завдання Cron (Один раз на день — ідеально!)',
    'settings.cron_exec_ok'                       => 'Цій сторінці було дозволено протестувати PHP звідси (необов’язково)',
    'settings.cron_maintenance_desc'              => 'pRD автоматично перевірила ваш веб-сервер і пропонує нічну команду. Вам усе одно потрібно вставити її у свої завдання Cron. Ви також можете запустити очищення зараз.',
    'settings.cron_maintenance_heading'           => 'Автоматичне обслуговування токенів та налаштування Cron',
    'settings.cron_php_ok'                        => 'Команду PHP знайдено',
    'settings.cron_script_ok'                     => 'Вітаємо — Ваш скрипт очищення на місці!',
    ...
    'settings.map_tile_api_key_help'              => 'Це потрібно для CARTO, Mapbox або Stadia. Залиште порожнім, щоб зберегти наявний ключ. Стандартний OpenStreetMap не потребує ключа.',
    'settings.map_tile_carto'                     => 'CARTO Voyager (безкоштовний ключ доступний на carto.com/basemaps/apikey)',
    'settings.map_tile_custom'                    => 'Користувацька URL-адреса тайлів',
    'settings.map_tile_default'                   => 'Безкоштовний за замовчуванням (OpenStreetMap)',
    ...
    'settings.mod_leaderboard_desc'               => 'Розпізнає зусилля з розшифровки та веде облік балів.',
    'settings.mod_leaderboard_note'               => '(Потрібне Керування користувачами та багатокористувацький доступ)',
    'settings.mod_maps'                           => 'Карти',
    'settings.mod_maps_desc'                      => 'Відображає географічну карту для кожної таблиці, яка має динамічну колонку розташування.',
    ...
    'settings.perm_save_failed'                   => 'Помилка: pRD не вдалося зберегти це налаштування.',
    'settings.perm_saved'                         => 'Збережено',
    'settings.perm_swipe'                         => 'На маленькому екрані прокрутіть цей список убік, якщо це необхідно.',
    ...
    'settings.subheading'                         => 'Керування виглядом, основною конфігурацією, поштовими драйверами, параметрами безпеки/CAPTCHA, модулями, режимом обслуговування, оголошеннями сайту та правами ролей.',
    'settings.sys_name_label'                     => 'Назва системи / додатка:',
    'settings.system_guest'                       => 'Система / Гість',
    'settings.tab_appearance'                     => 'Вигляд',
    ...
    'update_database.emergency_active'            => 'Доступ до оновлення бази даних відкрито, щоб ви могли завершити цей крок без входу в систему. Він закриється автоматично, щойно база даних стане актуальною.',
    'updates.already_current'                     => 'Файли вже відповідають вибраному каналу оновлення. Нічого не змінено.',
    'updates.apply_btn'                           => 'Застосувати пакет файлів',
    'updates.archive_failed'                      => 'Помилка: pRD не зміг записати приватну копію бази даних. Оновлення файлів не розпочалося.',
    'updates.archive_missing'                     => 'Помилка: цю приватну резервну копію не знайдено.',
    'updates.channel_help'                        => 'Будь ласка, не змінюйте канал оновлення, якщо ви не є розробником. Розробники можуть вказати тут мітку або посилання на коміт.',
    'updates.channel_label'                       => 'Канал оновлення (зазвичай повинен залишатися «Main»)',
    'updates.channel_saved'                       => 'Канал оновлення збережено.',
    'updates.confirm'                             => 'Бажаєте застосувати пакет файлів зараз? Не хвилюйтеся, ваші записи збережуться. Якщо ви ще цього не зробили, спочатку завантажте копію своєї бази даних.',
    'updates.db_behind'                           => 'База даних: є оновлення, що очікує на виконання',
    'updates.db_pending'                          => 'Якщо pRD попросить вас оновити базу даних далі, відкрийте цю сторінку. Вам не потрібно створювати жодних додаткових файлів.',
    'updates.db_ran'                              => 'Базу даних також оновлено.',
    'updates.download_heading'                    => 'Завантаження бази даних..',
    'updates.download_please'                     => 'Будь ласка, спочатку завантажте базу даних. Зберігайте власну копію, а також приватну копію сервера.',
    'updates.files_behind'                        => 'Файли: доступний новіший пакет',
    'updates.files_current'                       => 'Файли: відповідають вибраному каналу оновлення',
    'updates.files_error'                         => 'Файли: на жаль, pRD не зміг перевірити GitHub у цей момент. Будь ласка, спробуйте пізніше.',
    'updates.files_ok'                            => 'Вітаємо! Пакет файлів застосовано.',
    'updates.files_unknown'                       => 'Файли: ще не перевірено (застосуйте пакет один раз, щоб розпочати відстеження)',
    'updates.force_apply'                         => 'Примусово замінити файли (лише якщо щось виглядає пошкодженим)',
    'updates.heading'                             => 'Оновлення файлів',
    'updates.help'                                => 'Будь ласка, спочатку завантажте вашу базу даних. pRD також зберігає приватну копію на сервері. Оновлення файлів не змінює записи. Після оновлення файлів скористайтеся пунктом «Оновити базу даних», якщо очікується новіша версія бази даних.',
    'updates.now_db'                              => 'Якщо версія бази даних застаріла, скористайтеся далі пунктом «Оновити базу даних».',
    'updates.page_heading'                        => 'Оновлення pRD',
    'updates.private_copies'                      => 'Приватні копії сервера (лише для адміністратора)',
    'updates.running'                             => 'Цей сайт працює',
    ...
    'admin_users.not_verified_badge'              => 'Не підтверджено',
    ...
    'admin_users.reset_2fa_btn'                   => 'Вимкнути двофакторну автентифікацію (2FA)',
    ...
    'admin_users.verified_badge'                  => 'Підтверджено',
    ...
    'install.complete_desc'                       => 'Інсталяцію pRD налаштовано, а інсталятор заблоковано, щоб запобігти повторному запуску через помилку.',
    'install.complete_heading'                    => 'Вітаємо!',
    ...
    'install.delete_folder_hint'                  => 'Багато веб-хостингів не дозволяють інсталятору видаляти власну папку. Якщо кнопка не працює, відкрийте файловий менеджер хостингу або FTP, перейдіть до папки проєкту pRD та видаліть або перейменуйте директорію встановлення там.',
    ...
    'install.mod_feedback'                        => 'Надсилання відгуків',
    'install.mod_feedback_desc'                   => 'Включає публічну форму зворотного зв’язку та панель відстеження адміністратора.',
    'install.mod_leaderboard'                     => 'Таблиця лідерів та гейміфікація',
    ...
    'install.mod_moderation'                      => 'Робочий процес модерації',
    'install.mod_moderation_desc'                 => 'Система робочих процесів модерації, що дозволяє користувачам пропонувати правки, а модератору — схвалювати або відхиляти пропозицію.',
    'install.mod_users'                           => 'Керування користувачами та багатокористувацький доступ',
    'install.mod_users_desc'                      => 'Дозволити користувачам реєструватися та входити в систему.',
    'install.mod_volunteers'                      => 'Портал волонтерів та заявки',
    'install.mod_volunteers_desc'                 => 'Включає публічну форму волонтерських інтересів та панель управління адміністратора.',
    ...
    'install.modules_later'                       => 'Ви можете ввімкнути або вимкнути будь-який із цих модулів пізніше в розділі Адміністрування → Налаштування сайту.',
    ...
    'install.msg_modules_saved'                   => 'Вибір модулів збережено. Ви можете додати додаткові демонстраційні пакети або пропустити цей крок, якщо бажаєте.',
    ...
    'install.remove_already_gone'                 => 'Папку встановлення вже видалено.',
    'install.remove_failed'                       => 'Помилка: pRD не зміг автоматично видалити папку встановлення (веб-сервери часто не дозволяють цього). У файловому менеджері хостингу або через FTP відкрийте папку pRD та видаліть або перейменуйте директорію встановлення всередині неї.',
    'install.remove_folder_btn'                   => 'Будь ласка, видаліть папку встановлення (install)!',
    'install.remove_ok'                           => 'Папку встановлення видалено.',
    ...
    'save_data_entry.err_email'                   => 'Будь ласка, введіть дійсну електронну пошту для %s.',
    ...
    'save_data_entry.err_url'                     => 'Будь ласка, введіть веб-адресу, що починається з http:// або https:// для %s.',
    ...
    'data_entry.date_format_hint'                 => 'Будь ласка, використовуйте формат дати, вказаний у полі.',
    ...
    'data_entry.time_format_hint'                 => 'Будь ласка, використовуйте формат часу, вказаний у полі.',
