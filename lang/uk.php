...
return [
    ...
    'appearance.nav_help'                         => 'Це порядок для всього сайту. Користувачі все одно бачать лише ті посилання, на використання яких мають дозвіл. Навігація входу та профілю розташована окремо.',
