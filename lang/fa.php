...
return [
    ...
    'nav.zoom_reset'                              => 'بازنشانی اندازه متن',
    ...
    'record.heading'                              => 'رکورد',
    'record.print'                                => 'چاپ این رکورد',
    'record.view'                                 => 'مشاهده رکورد',
    ...
    'cols.print_filtered'                         => 'چاپ موارد فیلتر شده',
    ...
    'manage_tables.edit_metadata_btn'             => 'ویرایش جزئیات جدول',
    ...
    'manage_tables.intro'                         => 'می‌توانید نام‌ها، انواع فیلدها و آنچه در فهرست‌های جستجو یا صفحه رکورد خاص نمایش داده می‌شود را در اینجا تغییر دهید.',
    ...
    'manage_tables.req_toggle_label'              => 'الزامی کردن این ستون (ورود اجباری اطلاعات)',
    ...
    'manage_tables.show_in_record'                => 'نمایش در صفحه کامل رکورد',
    'manage_tables.status_hidden'                 => 'پنهان',
    'manage_tables.subheading'                    => 'می‌توانید نام‌ها، انواع فیلدها و آنچه در فهرست جستجو یا صفحه رکورد خاص نمایش داده می‌شود را تغییر دهید.',
    ...
    'manage_tables.type_boolean'                  => 'بولین (مرد / زن، تیک / ضربدر، درست / غلط، بله / خیر)',
    'manage_tables.type_choice'                   => 'لیست انتخابی',
    'manage_tables.type_date'                     => 'تاریخ',
    'manage_tables.type_email'                    => 'آدرس ایمیل',
    'manage_tables.type_int'                      => 'عدد صحیح',
    'manage_tables.type_location'                 => 'موقعیت مکانی (پین نقشه)',
    ...
    'user_emails.desc_outcome'                    => 'این ایمیل زمانی ارسال می‌شود که یک مدیر ویرایش پیشنهادی را بپذیرد یا رد کند و ارسال‌کننده درخواست ارسال ایمیل کرده باشد.',
    ...
    'user_emails.placeholders_hint'               => 'این توکن‌ها هنگام ارسال این قالب پر می‌شوند. فقط کارت‌های زیر برای قالبی که انتخاب کرده‌اید اعمال می‌شوند.',
    ...
    'appearance.brand_heading'                    => 'لوگو و شعار تبلیغاتی',
    'appearance.colors_heading'                   => 'رنگ‌ها',
    'appearance.colors_help'                      => 'کنتراست بالا همیشه این تنظیمات را هنگامی که فردی از آن کلید تغییر وضعیت استفاده می‌کند، لغو می‌کند.',
    'appearance.custom_heading'                   => 'لینک‌های سفارشی',
    'appearance.custom_help'                      => 'لطفاً به هر تعداد که نیاز دارید اضافه کنید. برای قرار دادن یک لینک زیر سرفصل دیگر یا یک منوی پیش‌فرض مثل مدیریت، والد را تنظیم کنید. برای سرفصل‌هایی که فقط یک عنوان هستند از # به عنوان آدرس استفاده کنید.',
    ...
    'appearance.drag'                             => 'لطفاً برای مرتب‌سازی مجدد بکشید',
    'appearance.nav_heading'                      => 'ناوبری',
    'appearance.nav_help'                         => 'می‌توانید دسته را بکشید تا لینک‌های پیش‌فرض و سفارشی را با هم مرتب کنید. برای قرار دادن یک لینک زیر مدیریت (یا سرفصل دیگر)، لطفاً والد را روی آن لینک تنظیم کنید. آدرس # سرفصلی بدون صفحه اختصاصی ایجاد می‌کند. ورود و پروفایل در موقعیت پیش‌فرض خود باقی می‌مانند.',
    'appearance.new_tab'                          => 'تب جدید',
    'appearance.parent_builtin'                   => 'منوهای پیش‌فرض',
    'appearance.parent_custom'                    => 'سرفصل‌های شما',
    'appearance.parent_none'                      => 'بالاترین سطح — آیتم منوی اختصاصی',
    'appearance.remove_link'                      => 'حذف',
    'appearance.reset'                            => 'بازنشانی به پیش‌فرض',
    'appearance.reset_ok'                         => 'ظاهر به ظاهر پیش‌فرض بازنشانی شد.',
    ...
    'settings.cron_command_label'                 => 'این هم دستوری که باید در کرون جابز خود قرار دهید (روزی یک بار کاملاً مناسب است!)',
    'settings.cron_exec_ok'                       => 'این صفحه اجازه تست PHP از اینجا را داشت (اختیاری)',
    'settings.cron_maintenance_desc'              => 'سیستم pRD به طور خودکار سرور وب شما را بررسی کرده و یک دستور شبانه پیشنهاد می‌کند. همچنان باید آن را در کرون جابز خود قرار دهید. همچنین می‌توانید همین حالا یک پاکسازی اجرا کنید.',
    'settings.cron_maintenance_heading'           => 'نگهداری خودکار توکن‌ها و تنظیمات کرون (Cron)',
    'settings.cron_php_ok'                        => 'دستور PHP یافت شد',
    'settings.cron_script_ok'                     => 'تبریک - اسکریپت پاکسازی شما آماده است!',
    ...
    'settings.map_tile_api_key_help'              => 'این برای CARTO، Mapbox یا Stadia مورد نیاز است. لطفاً برای حفظ کلید موجود، آن را خالی بگذارید. OpenStreetMap پیش‌فرض نیازی به کلید ندارد.',
    ...
    'settings.mod_leaderboard_desc'               => 'تلاش‌های رونیسی و پیاده‌سازی را تشخیص می‌دهد و امتیازات را حفظ می‌کند.',
    'settings.mod_leaderboard_note'               => '(نیازمند مدیریت کاربران و دسترسی چندکاربره است)',
    'settings.mod_maps'                           => 'نقشه‌ها',
    'settings.mod_maps_desc'                      => 'نمایش یک نقشه جغرافیایی برای هر جدولی که دارای ستون موقعیت مکانی پویا است.',
    ...
    'settings.perm_swipe'                         => 'در صفحه کوچک، لطفاً در صورت نیاز این فهرست را به صورت افقی بکشید.',
    ...
    'settings.subheading'                         => 'مدیریت ظاهر، پیکربندی اصلی، درایورهای ایمیل، گزینه‌های امنیتی/کپچا، ماژول‌ها، حالت تعمیر و نگهداری، اطلاعیه‌های سایت و قابلیت‌های نقش.',
    ...
    'update_database.emergency_active'            => 'دسترسی به به‌روزرسانی پایگاه داده باز است تا بتوانید این مرحله را بدون ورود به سیستم به پایان برسانید. هنگامی که پایگاه داده به‌روز شود، به طور خودکار بسته خواهد شد.',
    ...
    'updates.archive_failed'                      => 'متأسفیم - pRD نتوانست نسخه خصوصی پایگاه داده را بنویسد. به‌روزرسانی فایل آغاز نشد.',
    'updates.archive_missing'                     => 'متأسفیم - آن پشتیبان خصوصی یافت نشد.',
    ...
    'updates.channel_label'                       => 'کانال به‌روزرسانی (این مورد معمولاً باید روی «Main» باقی بماند)',
    'updates.channel_saved'                       => 'کانال به‌روزرسانی ذخیره شد.',
    'updates.confirm'                             => 'آیا مایلید بسته فایل را اکنون اعمال کنید؟ نگران نباشید، رکوردهای شما حفظ می‌شوند. اگر قبلاً این کار را نکرده‌اید، لطفاً ابتدا یک نسخه از پایگاه داده خود را بارگیری کنید.',
    'updates.db_behind'                           => 'پایگاه داده: یک به‌روزرسانی در انتظار است',
    'updates.db_pending'                          => 'اگر pRD از شما خواست که پایگاه داده را به‌روزرسانی کنید، لطفاً آن صفحه را باز کنید. نیازی به ایجاد هیچ فایل اضافه‌ای ندارید.',
    'updates.db_ran'                              => 'پایگاه داده نیز به‌روزرسانی شد.',
    'updates.download_heading'                    => 'در حال بارگیری پایگاه داده..',
    'updates.download_please'                     => 'لطفاً ابتدا پایگاه داده خود را بارگیری کنید. لطفاً نسخه خود و همچنین نسخه خصوصی سرور را نگه دارید.',
    'updates.files_behind'                        => 'فایل‌ها: بسته جدیدتری موجود است',
    'updates.files_current'                       => 'فایل‌ها: به‌روز با کانال به‌روزرسانی انتخاب‌شده',
    'updates.files_error'                         => 'فایل‌ها: متأسفیم، pRD نتوانست در حال حاضر گیت‌هاب را بررسی کند. لطفاً بعداً دوباره امتحان کنید.',
    'updates.files_ok'                            => 'تبریک می‌گوییم! بسته فایل اعمال شد.',
    'updates.files_unknown'                       => 'فایل‌ها: هنوز بررسی نشده است (لطفاً برای شروع ردیابی، یک بار بسته را اعمال کنید)',
    'updates.force_apply'                         => 'جایگزینی فایل‌ها به هر حال (فقط اگر چیزی آسیب‌دیده به نظر می‌رسد)',
    'updates.heading'                             => 'به‌روزرسانی‌های فایل',
    'updates.help'                                => 'لطفاً ابتدا پایگاه داده خود را بارگیری کنید. pRD همچنین یک نسخه خصوصی روی سرور نگه می‌دارد. به‌روزرسانی فایل رکوردهایی را تغییر نمی‌دهد. پس از به‌روزرسانی فایل‌ها، اگر نسخه جدیدتری از پایگاه داده در انتظار است، لطفاً از «به‌روزرسانی پایگاه داده» استفاده کنید.',
    'updates.no_sha'                              => 'هنوز هیچ بسته‌ای ثبت نشده است',
    'updates.now_db'                              => 'اگر نسخه پایگاه داده عقب است، لطفاً بعد از آن از «به‌روزرسانی پایگاه داده» استفاده کنید.',
    ...
    'admin_users.not_verified_badge'              => 'تایید نشده',
    ...
    'admin_users.reset_2fa_btn'                   => 'خاموش کردن احراز هویت دو مرحله‌ای',
    ...
    'admin_users.verified_badge'                  => 'تایید شده',
    ...
    'install.complete_desc'                       => 'نصب pRD شما اکنون راه‌اندازی شده و نصب‌کننده قفل شده است تا نتوان آن را به اشتباه دوباره اجرا کرد.',
    'install.complete_heading'                    => 'تبریک می‌گوییم!',
    ...
    'install.delete_folder_hint'                  => 'بسیاری از میزبان‌های وب به نصب‌کننده اجازه نمی‌دهند پوشه خود را حذف کند. اگر دکمه کاری انجام نمی‌دهد، لطفاً مدیر فایل هاست وب یا FTP خود را باز کنید، به پوشه پروژه pRD خود بروید و دایرکتوری نصب را در آنجا حذف یا تغییر نام دهید.',
    ...
    'install.mod_feedback_desc'                   => 'یک فرم بازخورد عمومی و داشبورد ردیابی مدیریت را فعال می‌کند.',
    ...
    'install.mod_moderation'                      => 'گردش کار تعدیل',
    'install.mod_moderation_desc'                 => 'یک سیستم گردش کار تعدیل که به کاربران اجازه می‌دهد ویرایش‌هایی را پیشنهاد دهند و به مدیر اجازه می‌دهد پیشنهاد را تأیید یا رد کند.',
    ...
    'install.mod_volunteers_desc'                 => 'یک فرم تمایل داوطلبانه عمومی و داشبورد مدیریت را فعال می‌کند.',
    ...
    'install.modules_later'                       => 'می‌توانید هر یک از این ماژول‌ها را بعداً در بخش مدیریت ← تنظیمات سایت روشن یا خاموش کنید.',
    ...
    'install.msg_modules_saved'                   => 'انتخاب‌های ماژول شما ذخیره شدند. می‌توانید بسته‌های نمایشی اختیاری اضافه کنید یا اگر ترجیح می‌دهید این مرحله را رد کنید.',
    ...
    'install.remove_failed'                       => 'متأسفیم - pRD نتوانست پوشه نصب را به طور خودکار حذف کند (سرورهای وب اغلب اجازه این کار را نمی‌دهند). در مدیر فایل هاست وب خود یا از طریق FTP، لطفاً پوشه pRD را باز کرده و دایرکتوری نصب داخل آن را حذف یا نام‌گذاری مجدد کنید.',
    ...
    'data_entry.date_format_hint'                 => 'لطفاً از فرمت تاریخ نشان داده شده در کادر استفاده کنید.',
    ...
    'data_entry.time_format_hint'                 => 'لطفاً از فرمت زمان نشان داده شده در کادر استفاده کنید.',
