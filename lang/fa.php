...
return [
    ...
    'appearance.nav_help'                         => 'این ترتیب برای کل سایت است. افراد همچنان فقط لینک‌هایی را می‌بینند که اجازه استفاده از آن‌ها را دارند. ناوبری ورود و پروفایل به‌صورت جداگانه قرار گرفته است.',
