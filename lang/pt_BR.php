...
return [
    ...
    'nav.similar_records'                         => 'Registros semelhantes',
    ...
    'nav.zoom_reset'                              => 'Redefinir tamanho do texto',
    ...
    'index.no_public_tables'                      => 'Não há tabelas disponíveis para o público neste site.',
    'record.back'                                 => 'Voltar para a lista',
    ...
    // ------------------------------------------------------------------
    'index.admin_add_columns_guide'               => 'Como Administrador, acesse Admin → Gerenciar Tabelas para adicionar pelo menos uma coluna à sua tabela.',
    'index.admin_create_table_guide'              => 'Como Administrador, acesse Admin → Gerenciar Tabelas para criar uma tabela e, em seguida, adicione pelo menos uma coluna a essa tabela antes que os registros possam ser exibidos ou inseridos.',
    ...
    'index.guest_login_tables_guide'              => 'Faça login como Administrador e acesse Admin → Gerenciar Tabelas para criar uma tabela e, em seguida, adicione pelo menos uma coluna.',
    ...
    'cols.print_now'                              => 'Imprimir ou salvar como PDF',
    'cols.show_heading'                           => 'Escolher quais colunas exibir',
    'cols.show_help'                              => 'Desmarque uma coluna para ocultá-la aqui, nos downloads e ao imprimir. Em um smartphone, menos colunas tornam a leitura mais fácil.',
    ...
    'manage_tables.err_col_name_empty'            => 'Por favor, insira o nome de uma coluna.',
    'manage_tables.err_col_name_taken'            => 'Esta tabela já possui uma coluna chamada %s. Por favor, escolha um nome diferente.',
    'manage_tables.err_table_name_empty'          => 'Por favor, insira o nome de uma tabela.',
    'manage_tables.err_table_name_taken'          => 'Já existe uma tabela chamada %s. Por favor, escolha um nome diferente.',
    'manage_tables.exclude_search_label'          => 'Excluir esta coluna da busca pública',
    'manage_tables.existing_cols_heading_prefix'  => 'Colunas existentes para',
    'manage_tables.heading'                       => 'Gerenciamento dinâmico de tabelas e colunas',
    'manage_tables.intro'                         => 'Aqui você pode alterar nomes, tipos de campos e o que aparece nas listas de busca ou na página de registro único.',
    ...
    'manage_tables.show_in_list'                  => 'Mostrar na lista de busca / entrada de dados',
    'manage_tables.show_in_record'                => 'Mostrar na página de registro completo',
    'manage_tables.status_hidden'                 => 'Oculto',
    'manage_tables.subheading'                    => 'Você pode alterar nomes, tipos de campos e o que aparece na lista de busca ou na página de registro único.',
    ...
    'manage_tables.type_boolean'                  => 'Booleano (Masculino / Feminino, Marca / Xis, Verdadeiro / Falso, Sim / Não)',
    'manage_tables.type_choice'                   => 'Lista de Escolha',
    'manage_tables.type_date'                     => 'Data',
    'manage_tables.type_email'                    => 'Endereço de E-mail',
    'manage_tables.type_int'                      => 'Inteiro (Número Inteiro)',
    'manage_tables.type_location'                 => 'Localização (Pin no Mapa)',
    'manage_tables.type_location_help'            => 'Os locais devem ser escolhidos a partir da busca para que possam aparecer no mapa desta tabela. Utilize uma coluna de texto normal se precisar apenas de um nome de local por escrito.',
    'manage_tables.type_text_long'                => 'Texto Longo',
    'manage_tables.type_time'                     => 'Horário',
    'manage_tables.type_url'                      => 'Endereço Web',
    'manage_tables.type_varchar'                  => 'Texto Curto',
    'manage_tables.url_new_tab'                   => 'Abrir em Nova Aba',
    ...
    'map.back_to_table'                           => 'Voltar para a tabela',
    'map.canvas_aria'                             => 'Mapa de registros',
    'map.filters'                                 => 'Filtros',
    'map.heading'                                 => 'Mapa',
    'map.help'                                    => 'Amplie para carregar os locais visíveis. Utilize os filtros para corresponder à busca da tabela.',
    'map.list_empty'                              => 'Nenhum local nesta visualização.',
    'map.list_heading'                            => 'Locais nesta visualização',
    'map.list_show_more'                          => 'Mostrar mais na lista (restam :n)',
    'map.open_btn'                                => 'Mapa',
    'map.skip_to_map'                             => 'Pular para o mapa',
    ...
    'user_emails.desc_outcome'                    => 'Isso é enviado quando um moderador aceita ou rejeita uma edição sugerida e o autor pediu para receber um e-mail.',
    ...
    'user_emails.placeholders_hint'               => 'Estes tokens são preenchidos quando este modelo é enviado. Apenas os cartões abaixo se aplicam ao modelo que você selecionou.',
    ...
    'dup_merge.confirm'                           => 'Deseja unir estes itens em um único registro? O outro registro será excluído.',
    'dup_merge.fields_caption'                    => 'Selecione um valor para cada campo',
    'dup_merge.heading'                           => 'Unir dois registros semelhantes',
    'dup_merge.intro'                             => 'Estes dois são cerca de %s%% semelhantes. Escolha qual registro manter e selecione um valor para cada campo.',
    'dup_merge.keep_a'                            => 'Manter registro #%s',
    'dup_merge.keep_b'                            => 'Manter registro #%s',
    'dup_merge.keep_legend'                       => 'Qual registro deve ser mantido?',
    'dup_merge.save_btn'                          => 'Unir em um único registro',
    'dup_merged'                                  => 'Esses dois registros agora são um só. A alteração consta no histórico do registro restante.',
    'dup_queue.choose_table'                      => 'Escolher uma tabela',
    'dup_queue.col_actions'                       => 'Ações',
    'dup_queue.col_records'                       => 'Registros',
    'dup_queue.col_score'                         => 'Grau de semelhança',
    'dup_queue.col_table'                         => 'Tabela',
    'dup_queue.dismiss_btn'                       => 'Não é uma duplicata',
    'dup_queue.dismissed'                         => 'Esse par foi marcado como não sendo uma duplicata.',
    'dup_queue.empty'                             => 'Nada na fila de espera. Escaneie uma tabela para procurar potenciais duplicatas anteriores.',
    'dup_queue.gone'                              => 'Essa revisão não está mais pendente.',
    'dup_queue.heading'                           => 'Registros semelhantes para revisar',
    'dup_queue.intro'                             => 'Pesquise em uma tabela por linhas que já pareçam semelhantes. Você pode indicar que são diferentes ou uni-las em um único registro.',
    'dup_queue.merge_btn'                         => 'Unir em um só',
    'dup_queue.scan_btn'                          => 'Escanear esta tabela',
    'dup_queue.scan_done'                         => 'Varredura concluída. %s pares semelhantes encontrados, %s novos itens adicionados à lista.',
    'dup_queue.scan_label'                        => 'Procurar registros semelhantes em',
    ...
    'moderate.dup_approved_note'                  => 'Aprovado. Isso agora é %s%% semelhante ao registro #%s.',
    'moderate.dup_blocked'                        => 'Não é possível aprovar: isso seria %s%% semelhante ao registro #%s.',
    ...
    'moderate.rationale_label'                    => 'Nota para a pessoa que sugeriu isso',
    'moderate.rationale_optional'                 => 'Nota opcional (salva no registro).',
    'moderate.rationale_placeholder'              => 'Por que você aceitou ou rejeitou esta alteração',
    'moderate.rationale_will_be_sent'             => 'Foi solicitado o envio de um e-mail. Sua nota abaixo será enviada exatamente como você a escreveu, portanto, mantenha um tom amigável e claro, por favor.',
    ...
    'moderate.tab_similar'                        => 'Registros semelhantes',
    ...
    'appearance.brand_heading'                    => 'Logotipo e slogan',
    'appearance.colors_heading'                   => 'Cores',
    'appearance.colors_help'                      => 'O alto contraste sempre substitui estas configurações quando alguém usa esse botão.',
    'appearance.custom_heading'                   => 'Links Personalizados',
    'appearance.custom_help'                      => 'Fique à vontade para adicionar quantos precisar. Defina o item principal (parent) para aninhar um link sob outro cabeçalho ou sob um menu embutido, como o Admin. Use # como endereço para um cabeçalho que seja apenas um título.',
    'appearance.custom_label'                     => 'Rótulo',
    ...
    'appearance.nav_help'                         => 'Você pode arrastar a alça para reordenar links embutidos e personalizados juntos. Para colocar um link sob o Admin (ou outro cabeçalho), defina o item principal (parent) nesse link. O endereço # cria um cabeçalho sem página própria. Início de sessão e perfil permanecem em sua posição embutida.',
    'appearance.new_tab'                          => 'Nova aba',
    'appearance.parent_builtin'                   => 'Menus Embutidos',
    'appearance.parent_custom'                    => 'Seus Cabeçalhos',
    'appearance.parent_none'                      => 'Nível Superior — Item de Menu Próprio',
    'appearance.remove_link'                      => 'Remover',
    'appearance.reset'                            => 'Redefinir para o padrão',
    'appearance.reset_ok'                         => 'Aparência redefinida para o visual padrão.',
    'appearance.save'                             => 'Salvar aparência',
    'appearance.saved'                            => 'Aparência salva.',
    'appearance.type_heading'                     => 'Tipo',
    'no_sha'                                      => 'Nenhum pacote registrado ainda',
    'role.label_admin'                            => 'Administrador',
    'role.label_guest'                            => 'Visitante público',
    'role.label_moderator'                        => 'Moderador',
    'role.label_user'                             => 'Usuário de entrada de dados',
    ...
    'settings.cron_command_label'                 => 'Aqui está o comando para colar nas suas tarefas Cron (Uma vez por dia é o ideal!)',
    'settings.cron_exec_ok'                       => 'Esta página teve permissão para testar o PHP a partir daqui (Opcional)',
    'settings.cron_maintenance_desc'              => 'O pRD analisou automaticamente o seu servidor web e sugere um comando noturno. Você ainda precisa colá-lo nas suas tarefas Cron. Também é possível executar uma limpeza agora.',
    ...
    'settings.cron_script_ok'                     => 'Parabéns - Seu script de limpeza está no lugar!',
    ...
    'settings.dup_heading'                        => 'Gerenciamento de registros duplicados',
    'settings.dup_help'                           => 'O pRD compara o texto digitado com outras linhas na mesma tabela. Você pode avisar os usuários, impedir o salvamento ou desativar esta função.',
    'settings.dup_legend'                         => 'Se um novo registro se parecer com um que você já possui',
    'settings.dup_mode_block'                     => 'Não permitir o salvamento',
    'settings.dup_mode_flag'                      => 'Avisar o usuário e registrar para um moderador caso salvem mesmo assim',
    'settings.dup_mode_off'                       => 'Não verificar registros semelhantes',
    'settings.dup_mode_warn'                      => 'Exibir um aviso — os usuários ainda podem salvar',
    'settings.dup_picky_exact'                    => 'Apenas quando as palavras coincidirem estritamente',
    'settings.dup_picky_label'                    => 'Quão rigorosa deve ser a verificação?',
    'settings.dup_picky_similar'                  => 'Detectar também correspondências próximas (ortografia semelhante)',
    ...
    'settings.map_geocode_api_key'                => 'Chave de API de busca de locais',
    'settings.map_geocode_api_key_help'           => 'Necessária apenas para LocationIQ ou OpenCage. Por favor, deixe em branco para manter uma chave existente. Sem uma chave, o Nominatim gratuito é utilizado.',
    'settings.map_geocode_locationiq'             => 'LocationIQ (chave de API obrigatória)',
    'settings.map_geocode_nominatim'              => 'Nominatim / OpenStreetMap (gratuito, com limite de requisições)',
    'settings.map_geocode_opencage'               => 'OpenCage (chave de API obrigatória)',
    'settings.map_geocode_provider'               => 'Busca de locais (geocodificação)',
    'settings.map_geocode_provider_help'          => 'Utilizado quando a entrada de dados busca um nome de local. Os resultados são armazenados em cache neste site.',
    'settings.map_key_placeholder'                => 'Por favor, cole a chave se necessário (deixe em branco para manter a atual)',
    'settings.map_provider_heading'               => 'Configuração do provedor de mapas',
    'settings.map_provider_intro'                 => 'Opcional. Por favor, deixe estes campos em branco para utilizar as imagens de mapas integradas gratuitas (CARTO/OpenStreetMap) e a busca de locais gratuita (Nominatim). As chaves pagas permanecem no seu servidor e não são compartilhadas com outros sites.',
    'settings.map_tile_api_key'                   => 'Chave de API de tiles do mapa',
    'settings.map_tile_api_key_help'              => 'Isso é necessário para CARTO, Mapbox ou Stadia. Deixe em branco para manter uma chave existente. O OpenStreetMap padrão não precisa de chave.',
    'settings.map_tile_carto'                     => 'CARTO Voyager (Chave gratuita disponível em carto.com/basemaps/apikey)',
    'settings.map_tile_custom'                    => 'URL de tile personalizada',
    'settings.map_tile_default'                   => 'Padrão gratuito (OpenStreetMap)',
    'settings.map_tile_mapbox'                    => 'Mapbox (chave de API obrigatória)',
    'settings.map_tile_osm'                       => 'OpenStreetMap (gratuito)',
    'settings.map_tile_provider'                  => 'Imagens do mapa (tiles/ladris)',
    'settings.map_tile_provider_help'             => 'Se uma opção paga não tiver chave, o pRD recorre por padrão à opção gratuita.',
    'settings.map_tile_stadia'                    => 'Stadia Maps (chave de API obrigatória)',
    ...
    'settings.mod_maps_desc'                      => 'Exibe um mapa geográfico para cada tabela que possui uma coluna de localização dinâmica.',
    ...
    'settings.perm_save_failed'                   => 'Desculpe - o pRD não conseguiu salvar esta configuração.',
    'settings.perm_saved'                         => 'Salvo',
    'settings.perm_swipe'                         => 'Em telas pequenas, deslize esta lista para os lados, se necessário.',
    ...
    'settings.subheading'                         => 'Gerenciar aparência, configuração principal, drivers de e-mail, opções de segurança/CAPTCHA, módulos, modo de manutenção, anúncios do site e permissões de funções.',
    ...
    'update_database.emergency_active'            => 'O acesso à atualização do banco de dados está aberto para que você possa concluir esta etapa sem fazer login. Ele será fechado automaticamente quando o banco de dados estiver atualizado.',
    'updates.already_current'                     => 'Os arquivos já correspondem ao canal de atualização selecionado. Nada foi alterado.',
    'updates.apply_btn'                           => 'Aplicar pacote de arquivos',
    'updates.archive_failed'                      => 'Desculpe - o pRD não conseguiu gravar a cópia privada do banco de dados. A atualização de arquivos não foi iniciada.',
    'updates.archive_missing'                     => 'Desculpe - esse backup privado não foi encontrado.',
    'updates.channel_help'                        => 'Não altere o canal de atualização a menos que você seja um desenvolvedor. Desenvolvedores podem colocar uma tag ou uma referência de commit nesta caixa.',
    'updates.channel_label'                       => 'Canal de atualização (normalmente deve ser deixado como "Main")',
    'updates.channel_saved'                       => 'Canal de atualização salvo.',
    'updates.confirm'                             => 'Deseja aplicar o pacote de arquivos agora? Não se preocupe, seus registros serão mantidos. Baixe uma cópia do seu banco de dados primeiro, caso ainda não tenha feito isso.',
    'updates.db_behind'                           => 'Banco de dados: há uma atualização pendente',
    'updates.db_pending'                          => 'Se o pRD pedir para você atualizar o banco de dados em seguida, abra essa página. Você não precisa criar nenhum arquivo adicional.',
    'updates.db_ran'                              => 'O banco de dados também foi atualizado.',
    'updates.download_heading'                    => 'Baixando seu banco de dados..',
    'updates.download_please'                     => 'Baixe primeiro o seu banco de dados. Guarde a sua própria cópia, bem como a cópia privada do servidor.',
    'updates.files_behind'                        => 'Arquivos: há um pacote mais recente disponível',
    'updates.files_current'                       => 'Arquivos: atualizados com o canal de atualização selecionado',
    'updates.files_error'                         => 'Arquivos: desculpe, o pRD não conseguiu verificar o GitHub no momento. Tente novamente mais tarde.',
    'updates.files_ok'                            => 'Parabéns! Pacote de arquivos aplicado.',
    'updates.files_unknown'                       => 'Arquivos: ainda não verificados (aplique um pacote uma vez para iniciar o rastreamento)',
    'updates.force_apply'                         => 'Substituir arquivos mesmo assim (apenas se algo parecer danificado)',
    'updates.heading'                             => 'Atualizações de arquivos',
    'updates.help'                                => 'Baixe primeiro o seu banco de dados. O pRD também mantém uma cópia privada no servidor. A atualização de arquivos não altera os registros. Após atualizar os arquivos, utilize "Atualizar banco de dados" se houver uma versão de banco de dados mais recente pendente.',
    'updates.now_db'                              => 'Se a versão do banco de dados estiver desatualizada, utilize "Atualizar banco de dados" em seguida.',
    'updates.page_heading'                        => 'Atualizando o pRD',
    'updates.private_copies'                      => 'Cópias privadas do servidor (apenas administradores)',
    ...
    'install.admin_subheading'                    => 'Estes são os dados de login para este site (e não para o banco de dados).',
    'install.admin_username_label'                => 'Nome de Usuário do Administrador',
    'install.back_btn'                            => 'Voltar',
    'install.close_alert'                         => 'Fechar',
    'install.complete_desc'                       => 'A sua instalação do pRD está configurada e o instalador foi bloqueado para que não possa ser executado novamente por engano.',
    ...
    'install.db_hint'                             => 'Por favor, use os detalhes do MySQL do painel de controle da sua hospedagem. Este não é o login de Administrador do site (isso vem logo depois).',
    ...
    'install.delete_folder_hint'                  => 'Muitos serviços de hospedagem web não permitem que o instalador exclua sua própria pasta. Se o botão não fizer nada, abra o gerenciador de arquivos da sua hospedagem ou cliente FTP, vá até a pasta do seu projeto pRD e exclua ou renomeie o diretório de instalação lá.',
    ...
    'install.mod_feedback'                        => 'Envios de feedback',
    'install.mod_feedback_desc'                   => 'Ativa um formulário de feedback público e um painel de controle de acompanhamento administrativo.',
    'install.mod_leaderboard'                     => 'Tabela de classificação e gamificação',
    'install.mod_leaderboard_desc'                => 'Tabela de pontos opcional. Requer que as contas de usuário estejam ativadas.',
    'install.mod_maps'                            => 'Mapas',
    'install.mod_maps_desc'                       => 'Campos de localização e um mapa por tabela. Você pode alterar isso depois em Admin → Configurações.',
    'install.mod_moderation'                      => 'Fluxo de trabalho de moderação',
    'install.mod_moderation_desc'                 => 'Um sistema de fluxo de trabalho de moderação que permite aos usuários sugerir edições e a um moderador aprovar ou rejeitar a sugestão.',
    'install.mod_users'                           => 'Gerenciamento de usuários e acesso multiusuário',
    'install.mod_users_desc'                      => 'Permitir que as pessoas se registrem e façam login.',
    'install.mod_volunteers'                      => 'Portal de voluntários e submissões',
    'install.mod_volunteers_desc'                 => 'Ativa um formulário público de interesse em voluntariado e um painel de controle de gestão administrativa.',
    'install.modules_continue'                    => 'Salvar e continuar',
    'install.modules_heading'                     => 'Quais partes do pRD você gostaria de usar?',
    'install.modules_help'                        => 'Por favor, selecione as funcionalidades desejadas desde o primeiro dia. Você pode alterar isso mais tarde em Administração → Configurações do site.',
    'install.modules_later'                       => 'Você pode ativar ou desativar qualquer um destes módulos mais tarde em Admin → Configurações do site.',
    ...
    'install.msg_modules_saved'                   => 'Suas escolhas de módulos foram salvas. Você pode adicionar pacotes de demonstração opcionais ou ignorar esta etapa, se preferir.',
    ...
    'install.remove_already_gone'                 => 'A pasta de instalação já havia sido removida.',
    'install.remove_failed'                       => 'Desculpe - o pRD não conseguiu excluir automaticamente a pasta de instalação (os servidores web geralmente não permitem isso). No gerenciador de arquivos da sua hospedagem web ou via FTP, abra a pasta pRD e exclua ou renomeie o diretório de instalação dentro dela.',
    ...
    'footer.software_notice'                      => 'pRD (V1.18) é de código aberto sob a Licença MIT - Agradecimentos à @katherinehuk no GitHub por dar uma segunda olhada!',

    // ------------------------------------------------------------------
    // 31. Site Header & Head
    // ------------------------------------------------------------------
    'header.default_title'                        => 'Banco de Dados de Registros Paroquiais',
    'header.skip_to_content'                      => 'Pular para o conteúdo principal',
    ...
    'save_data_entry.err_url'                     => 'Por favor, insira um endereço web iniciando com http:// ou https:// para %s.',
    ...
    'data_entry.admin_cols_prompt'                => 'Se você for um Administrador, acesse Admin → Gerenciar Tabelas para gerenciar colunas e adicionar pelo menos uma coluna a esta tabela.',
    'data_entry.admin_tables_prompt'              => 'Se você for um Administrador, acesse Admin → Gerenciar Tabelas para adicionar uma tabela e, em seguida, adicione pelo menos uma coluna.',
    ...
    'data_entry.date_format_hint'                 => 'Utilize o formato de data exibido na caixa.',
    ...
    'data_entry.delete_record_btn'                => 'Excluir',
    'data_entry.delete_record_confirm'            => 'Deseja excluir este registro permanentemente? Os valores, marcadores do mapa e sugestões relacionadas serão removidos. Esta ação não pode ser desfeita.',
    'data_entry.dup_blocked'                      => 'Este registro é muito semelhante a um já salvo, portanto não pode ser adicionado.',
    'data_entry.dup_close_match'                  => 'Ortografia muito semelhante',
    'data_entry.dup_confirm_btn'                  => 'Sim, confirmar e salvar duplicata',
    'data_entry.dup_desc'                         => 'Por favor, verifique os cards abaixo. Você ainda pode salvar se este for um registro diferente.',
    'data_entry.dup_empty'                        => '(vazio)',
    'data_entry.dup_flag_btn'                     => 'Salvar e notificar um moderador',
    'data_entry.dup_heading'                      => '⚠️ Aviso de Possível Duplicata',
    'data_entry.dup_item_format'                  => 'ID do Registro: %d — Valor: %s',
    'data_entry.dup_overview'                     => 'Já salvo',
    'data_entry.dup_prompt'                       => 'Deseja prosseguir e salvar esta duplicata mesmo assim?',
    'data_entry.dup_review_btn'                   => 'Revisar o que escrevi',
    'data_entry.dup_score_exact'                  => 'Semelhança calculada: %s por cento.',
    'data_entry.dup_similar'                      => 'Isso é %s%% semelhante ao registro #%s',
    'data_entry.edit_record_btn'                  => 'Editar',
    'data_entry.edit_record_saved'                => 'O registro foi atualizado.',
    ...
    'data_entry.go_manage_tables'                 => 'Por favor, acesse Admin → Gerenciar Tabelas',
    ...
    'data_entry.location_busy'                    => 'A busca de locais está ocupada. Tente novamente em um minuto.',
    'data_entry.location_color'                   => 'Cor do marcador',
    'data_entry.location_help'                    => 'Pesquise o local tal como é conhecido hoje, escolha uma correspondência e, em seguida, você poderá intitular o rótulo com o nome antigo. O título e o texto breve são obrigatórios para a janela pop-up do mapa.',
    'data_entry.location_label'                   => 'Nome a exibir (você pode usar um nome histórico)',
    'data_entry.location_none'                    => 'Nenhum local correspondente. Tente uma cidade próxima.',
    'data_entry.location_results'                 => 'Você quis dizer',
    ...
    'data_entry.location_show_on_map_help'        => 'Desmarque para manter o registro na tabela, mas ocultar o marcador (por exemplo, se ainda não estiver aberto).',
    ...
    'data_entry.record_deleted'                   => 'O registro foi excluído.',
    ...
    'data_entry.time_format_hint'                 => 'Utilize o formato de hora exibido na caixa.',
    ...
    'login.err_password_required'                 => 'Por favor, insira sua senha.',
    'login.err_username_required'                 => 'Por favor, insira seu nome de usuário.',
    ...
    'set_password.msg_ready'                      => 'Senha configurada com sucesso! Agora você pode fazer login.',
    'set_password.msg_ready_onboarding'           => 'Senha salva. Faça login — você será guiado por uma rápida configuração.',
    ...
    'suggest_edit.decision_accepted'              => 'Aceito',
    'suggest_edit.decision_not_accepted'          => 'Não aceito',
    'suggest_edit.dup_of_help'                    => 'Opcional. Os moderadores verão esta nota.',
    'suggest_edit.dup_of_label'                   => 'Se você souber o número do outro registro, pode adicioná-lo aqui',
    'suggest_edit.dup_please_check'               => 'Esta alteração ficaria muito semelhante a outro registro. Por favor, verifique abaixo.',
    'suggest_edit.empty_label'                    => '(vazio)',
    'suggest_edit.err_notify_email'               => 'Por favor, insira um endereço de e-mail se quiser saber o resultado.',
    'suggest_edit.heading_prefix'                 => 'Sugerir Edição para o Registro',
    'suggest_edit.leave_blank'                    => 'Deixe este campo em branco',
    'suggest_edit.no_rationale'                   => 'Nenhuma nota adicional foi adicionada.',
    'suggest_edit.notify_email_help'              => 'Usado apenas para informar o resultado. Não é exibido no registro público.',
    'suggest_edit.notify_email_label'             => 'Seu endereço de e-mail',
    ...
    'suggest_edit.report_dup'                     => 'Acho que este registro é uma duplicata de outro',
