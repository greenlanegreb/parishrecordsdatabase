...
return [
    ...
    'index.no_public_tables'                      => '本网站目前没有可供公众访问的数据表。',
    'record.back'                                 => '返回列表',
    'record.heading'                              => '记录',
    'record.print'                                => '打印此记录',
    'record.view'                                 => '查看记录',
    ...
    // ------------------------------------------------------------------
    'index.admin_add_columns_guide'               => '作为管理员，请前往“管理员”→“管理表”以为您的表至少添加一列。',
    'index.admin_create_table_guide'              => '作为管理员，请前往“管理员”→“管理表”以创建一个表，然后在该表中至少添加一列，之后才能显示或输入记录。',
    ...
    'index.guest_login_tables_guide'              => '请以管理员身份登录并前往“管理员”→“管理表”以创建一个表，然后至少添加一列。',
    ...
    'cols.back'                                   => '返回',
    'cols.print_btn'                              => '打印',
    'cols.print_entire'                           => '打印全部',
    'cols.print_filtered'                         => '打印筛选后的内容',
    'cols.print_now'                              => '打印或保存为 PDF',
    'cols.show_heading'                           => '选择要显示的列',
    'cols.show_help'                              => '取消勾选某一列可在当前页面、下载以及打印时将其隐藏。在手机上，较少的列数更易于阅读。',
    ...
    'manage_tables.edit_metadata_btn'             => '编辑表格详情',
    'manage_tables.edit_table_summary'            => '编辑表定义：',
    'manage_tables.err_col_name_empty'            => '请输入列名。',
    'manage_tables.err_col_name_taken'            => '该表已存在名为 %s 的列。请选择其他名称。',
    'manage_tables.err_table_name_empty'          => '请输入表名。',
    'manage_tables.err_table_name_taken'          => '名为 %s 的表已存在。请选择其他名称。',
    'manage_tables.exclude_search_label'          => '从公开搜索中排除此列',
    'manage_tables.existing_cols_heading_prefix'  => '现有列：',
    'manage_tables.heading'                       => '动态数据表与列管理',
    'manage_tables.intro'                         => '您可以在此处修改名称、字段类型，以及在搜索列表或独立记录页面上显示的内容。',
    ...
    'manage_tables.show_in_list'                  => '在搜索/数据录入列表中显示',
    'manage_tables.show_in_record'                => '在完整记录页面中显示',
    'manage_tables.status_hidden'                 => '隐藏',
    'manage_tables.subheading'                    => '您可以更改名称、字段类型，以及搜索列表或独立记录页面上显示的内容。',
    ...
    'manage_tables.type_boolean'                  => '布尔值 (男 / 女, 勾选 / 叉号, 正确 / 错误, 是 / 否)',
    'manage_tables.type_choice'                   => '选项列表',
    'manage_tables.type_date'                     => '日期',
    'manage_tables.type_email'                    => '电子邮箱地址',
    ...
    'manage_tables.type_text_long'                => '长文本',
    'manage_tables.type_time'                     => '时间',
    'manage_tables.type_url'                      => '网页地址',
    'manage_tables.type_varchar'                  => '短文本',
    'manage_tables.url_new_tab'                   => '在新标签页中打开',
    'manage_tables.yes'                           => '是',
    ...
    'user_emails.desc_outcome'                    => '当版主接受或拒绝建议的修改且提交者请求接收邮件通知时，将发送此邮件。',
    ...
    'user_emails.opt_suggestion_outcome'          => '编辑建议的处理结果',
    'user_emails.placeholders_hint'               => '发送此模板时将填充这些占位符。只有以下卡片适用于您所选的模板。',
    ...
    // ------------------------------------------------------------------
    'dup_merge.col_a'                             => '记录 #%s',
    'dup_merge.col_b'                             => '记录 #%s',
    'dup_merge.col_field'                         => '字段',
    'dup_merge.confirm'                           => '确定要将这些项合并为一条记录吗？另一条记录将被删除。',
    'dup_merge.fields_caption'                    => '为每个字段选择一个值',
    'dup_merge.heading'                           => '合并两个相似记录',
    'dup_merge.intro'                             => '这两项内容的相似度约为 %s%%。请选择要保留的记录，然后为每个字段选择对应的值。',
    'dup_merge.keep_a'                            => '保留记录 #%s',
    'dup_merge.keep_b'                            => '保留记录 #%s',
    'dup_merge.keep_legend'                       => '应保留哪条记录？',
    'dup_merge.save_btn'                          => '合并为一条记录',
    'dup_merge_btn'                               => '合并为一条记录',
    'dup_merged'                                  => '这两个记录现在已合并为一条。相关更改已记录在保留记录的历史中。',
    'dup_queue.choose_table'                      => '选择表格',
    'dup_queue.col_actions'                       => '操作',
    'dup_queue.col_records'                       => '记录',
    'dup_queue.col_score'                         => '相似度',
    'dup_queue.col_table'                         => '表',
    'dup_queue.dismiss_btn'                       => '不是重复项',
    'dup_queue.dismissed'                         => '该对记录已被标记为非重复项。',
    'dup_queue.empty'                             => '没有等待处理的项目。请扫描表格以查找以往的相似记录。',
    'dup_queue.gone'                              => '该审核项目已不在等待队列中。',
    'dup_queue.heading'                           => '待审核的相似记录',
    'dup_queue.intro'                             => '扫描表格以查找内容已经很相似的行。您可以将其标记为不同，或者合并为一个记录。',
    'dup_queue.scan_btn'                          => '扫描此表',
    'dup_queue.scan_done'                         => '扫描完成。找到 %s 对相似项，已向列表添加 %s 个新项目。',
    'dup_queue.scan_label'                        => '在以下位置搜索相似记录',
    ...
    'moderate.dup_approved_note'                  => '已批准。此项目前与记录 #%s 的相似度为 %s%%。',
    'moderate.dup_blocked'                        => '无法批准：此项与记录 #%s 的相似度达 %s%%。',
    ...
    'moderate.rationale_label'                    => '给提出此建议者的备注',
    'moderate.rationale_optional'                 => '可选备注（将保留在记录上）。',
    'moderate.rationale_placeholder'              => '接受或拒绝此更改的原因',
    'moderate.rationale_will_be_sent'             => '对方已要求接收电子邮件。您在下方填写的备注将按原样发送，因此请保持语气友善和清晰。',
    ...
    'moderate.tab_similar'                        => '相似记录',
    'moderate.tab_suggestions'                    => '建议',
    ...
    // ------------------------------------------------------------------
    'appearance.add_link'                         => '添加链接',
    'appearance.brand_heading'                    => '徽标与标语',
    'appearance.colors_heading'                   => '颜色',
    'appearance.colors_help'                      => '当启用高对比度开关时，它将始终覆盖这些设置。',
    'appearance.custom_heading'                   => '自定义链接',
    'appearance.custom_help'                      => '请根据需要自由添加。设置父级可以将链接嵌套在另一个标题下方或内置菜单（例如管理后台）下方。请使用 # 作为仅作为标题的链接地址。',
    'appearance.custom_label'                     => '标签',
    'appearance.custom_parent'                    => '父级',
    'appearance.custom_url'                       => '地址',
    'appearance.custom_who'                       => '谁可以查看',
    'appearance.drag'                             => '请拖动以重新排序',
    'appearance.nav_heading'                      => '导航',
    'appearance.nav_help'                         => '您可以拖动把手将内置链接和自定义链接一起重新排序。若要将链接放置在管理后台（或其他标题）下方，请为该链接设置父级。地址 # 用于创建没有独立页面的标题。登录和个人资料将保留在其内置位置。',
    'appearance.new_tab'                          => '新标签页',
    'appearance.parent_builtin'                   => '内置菜单',
    'appearance.parent_custom'                    => '您的标题',
    'appearance.parent_none'                      => '顶层 — 自定义菜单项',
    'appearance.remove_link'                      => '移除',
    'appearance.reset'                            => '恢复默认',
    'appearance.reset_ok'                         => '外观已重置为默认样式。',
    'appearance.save'                             => '保存外观',
    'appearance.saved'                            => '外观已保存。',
    'appearance.type_heading'                     => '类型',
    'no_sha'                                      => '尚未记录任何安装包',
    ...
    'settings.cron_command_label'                 => '以下是要粘贴到 Cron 任务中的命令（一天一次效果最佳！）',
    'settings.cron_exec_ok'                       => '已允许此页面在此处测试 PHP（可选）',
    'settings.cron_maintenance_desc'              => 'pRD 已自动检测您的网络服务器并建议了一条夜间命令。您仍需将其粘贴到您的 Cron 任务中。您也可以现在运行一次清理。',
    'settings.cron_maintenance_heading'           => '自动化令牌维护与 Cron 设置',
    'settings.cron_php_ok'                        => '已找到 PHP 命令',
    'settings.cron_script_ok'                     => '恭喜 - 您的清理脚本已就绪！',
    ...
    'settings.dup_heading'                        => '重复记录管理',
    'settings.dup_help'                           => 'pRD 会将输入的文本与同表中的其他行进行比较。您可以向用户发出警告、阻止保存或关闭此功能。',
    'settings.dup_legend'                         => '如果新记录与您已有的记录相似',
    'settings.dup_mode_block'                     => '不允许保存',
    'settings.dup_mode_flag'                      => '警告用户，如果其坚持保存则标记以便管理员复查',
    'settings.dup_mode_off'                       => '不检查相似记录',
    'settings.dup_mode_warn'                      => '显示警告 — 用户仍可继续保存',
    'settings.dup_picky_exact'                    => '仅当词语高度匹配时',
    'settings.dup_picky_label'                    => '查重严格程度如何？',
    'settings.dup_picky_similar'                  => '检测近似项（拼写相似）',
    ...
    'settings.map_tile_api_key_help'              => 'CARTO、Mapbox 或 Stadia 需要此项。留空以保留现有密钥。默认的 OpenStreetMap 不需要密钥。',
    'settings.map_tile_carto'                     => 'CARTO Voyager（免费密钥可从 carto.com/basemaps/apikey 获取）',
    'settings.map_tile_custom'                    => '自定义瓦片 URL',
    'settings.map_tile_default'                   => '免费默认（OpenStreetMap）',
    ...
    'settings.mod_leaderboard_desc'               => '认可转录工作并统计积分。',
    'settings.mod_leaderboard_note'               => '(需要用户管理和多用户访问)',
    'settings.mod_maps'                           => '地图',
    'settings.mod_maps_desc'                      => '为具有动态位置列的每个数据表显示地理地图。',
    ...
    'settings.perm_locked'                        => '此权限对管理员是强制要求的。',
    'settings.perm_more_info'                     => '了解更多关于',
    'settings.perm_needs'                         => '需要',
    'settings.perm_needs_parent'                  => '请先启用该项。',
    'settings.perm_no_links'                      => '此权限不依赖于其他权限。',
    'settings.perm_save_failed'                   => '抱歉 - pRD 无法保存此设置。',
    'settings.perm_saved'                         => '已保存',
    'settings.perm_swipe'                         => '在小屏幕上，如有必要，请横向滑动此列表。',
    'settings.perm_used_by'                       => '依赖于',
    ...
    'settings.subheading'                         => '管理外观、核心配置、邮件驱动、安全/验证码选项、模块、维护模式、网站公告及角色权限。',
    ...
    'update_database.emergency_active'            => '数据库更新访问权限已开放，以便您无需登录即可完成此步骤。数据库更新至最新后它将自动关闭。',
    'updates.already_current'                     => '文件已与所选更新渠道匹配，未作任何更改。',
    'updates.apply_btn'                           => '应用文件包',
    'updates.archive_failed'                      => '抱歉 - pRD 无法写入私有数据库副本。文件更新未能启动。',
    'updates.archive_missing'                     => '抱歉 - 未找到该私有备份。',
    'updates.channel_help'                        => '除非您是开发人员，否则请勿更改更新渠道。开发人员可以在此框中输入标签或提交引用（commit reference）。',
    'updates.channel_label'                       => '更新渠道（通常应保留为“Main”）',
    'updates.channel_saved'                       => '更新渠道已保存。',
    'updates.confirm'                             => '您现在要应用文件包吗？请放心，您的记录将会保留。如果尚未操作，请先下载数据库的副本。',
    'updates.db_behind'                           => '数据库：有一个挂起的更新',
    'updates.db_pending'                          => '如果 pRD 接下来要求您更新数据库，请打开该页面。您无需创建任何额外文件。',
    'updates.db_ran'                              => '数据库也已同时更新。',
    'updates.download_heading'                    => '正在下载您的数据库..',
    'updates.download_please'                     => '请先下载您的数据库。请妥善保存您自己的副本以及服务器私有副本。',
    'updates.files_behind'                        => '文件：有可用的更新版本包',
    'updates.files_current'                       => '文件：与所选更新渠道保持同步和最新',
    'updates.files_error'                         => '文件：抱歉，pRD 目前无法检查 GitHub。请稍后重试。',
    'updates.files_ok'                            => '恭喜！文件包已成功应用。',
    'updates.files_unknown'                       => '文件：尚未检查（请应用一次安装包以开始追踪）',
    'updates.force_apply'                         => '强制替换文件（仅在某些内容显示损坏时使用）',
    'updates.heading'                             => '文件更新',
    'updates.help'                                => '请先下载您的数据库。pRD 也会在服务器上保留一个私有副本。文件更新不会更改记录。文件更新后，如果发现有等待更新的较新数据库版本，请使用“更新数据库”。',
    'updates.now_db'                              => '如果数据库版本落后，请接下来使用“更新数据库”。',
    'updates.page_heading'                        => '更新 pRD',
    'updates.private_copies'                      => '服务器私有副本（仅限管理员）',
    'updates.running'                             => '本网站正在运行',
    ...
    'admin_users.not_verified_badge'              => '未验证',
    ...
    'admin_users.reset_2fa_btn'                   => '关闭两步验证 (2FA)',
    ...
    'admin_users.verified_badge'                  => '已验证',
    ...
    'install.admin_subheading'                    => '这是该网站的登录信息（不是数据库的登录信息）。',
    'install.admin_username_label'                => '管理员用户名',
    'install.back_btn'                            => '返回',
    'install.close_alert'                         => '关闭',
    'install.complete_desc'                       => '您的 pRD 安装现已配置完毕，安装程序已被锁定，以防由于失误被再次运行。',
    'install.complete_heading'                    => '恭喜！',
    'install.complete_title'                      => '安装已完成',
    'install.continue_btn'                        => '继续',
    'install.db_heading'                          => '数据库连接',
    'install.db_hint'                             => '请使用您的主机控制面板中的 MySQL 详细信息。这不是网站管理员登录（那将在后面）。',
    ...
    'install.delete_folder_hint'                  => '许多虚拟主机不允许安装程序删除自身的文件夹。如果该按钮无效，请打开您的虚拟主机文件管理器或 FTP，转到 pRD 项目文件夹，然后删除或重命名那里的安装目录。',
    ...
    'install.mod_feedback'                        => '反馈提交',
    'install.mod_feedback_desc'                   => '启用公开反馈表单及管理追踪面板。',
    'install.mod_leaderboard'                     => '排行榜与游戏化',
    'install.mod_leaderboard_desc'                => '可选的积分表。需要启用用户账号。',
    'install.mod_maps'                            => '地图',
    'install.mod_maps_desc'                       => '每个表格的位置字段和地图。您稍后可以在“管理” → “设置”中更改此项。',
    'install.mod_moderation'                      => '审核工作流',
    'install.mod_moderation_desc'                 => '一个审核工作流系统，允许用户建议修改，并由版主批准或拒绝该建议。',
    'install.mod_users'                           => '用户管理与多用户访问',
    'install.mod_users_desc'                      => '允许用户注册和登录。',
    'install.mod_volunteers'                      => '志愿者门户与提交',
    'install.mod_volunteers_desc'                 => '启用公开志愿者意向表单及管理控制面板。',
    'install.modules_continue'                    => '保存并继续',
    'install.modules_heading'                     => '您想使用 pRD 的哪些部分？',
    'install.modules_help'                        => '请勾选您从第一天起就想使用的功能。您以后可以在“管理”→“网站设置”中更改这些设置。',
    'install.modules_later'                       => '您以后可以随时在“管理 → 网站设置”中开启或关闭这些模块。',
    ...
    'install.msg_modules_saved'                   => '您的模块选择已保存。如果您愿意，可以添加可选的演示包，或者跳过此步骤。',
    'install.msg_schema_imported'                 => '数据库已连接且架构已导入。请创建您的管理员账号。',
    'install.page_title'                          => '安装 — 教区户籍记录目录',
    'install.remove_already_gone'                 => '安装文件夹已经被移除。',
    'install.remove_failed'                       => '抱歉 - pRD 无法自动删除安装文件夹（网络服务器通常不允许这样做）。请在您的虚拟主机文件管理器中或通过 FTP，打开 pRD 文件夹并删除或重命名其中的安装目录。',
    'install.remove_folder_btn'                   => '请删除安装文件夹！',
    'install.remove_ok'                           => '安装文件夹已成功移除。',
    ...
    'footer.software_notice'                      => 'pRD (V1.18) 是在 MIT 许可证下开源的软件 - 感谢 GitHub 上的 @katherinehuk 提供审阅帮助！',
    ...
    // ------------------------------------------------------------------
    // 34. Standalone Update Database Gateway and Settings Database Update
    // ------------------------------------------------------------------
    ...
    'save_data_entry.err_email'                   => '请为 %s 输入有效的电子邮箱地址。',
    ...
    'save_data_entry.err_url'                     => '请为 %s 输入以 http:// 或 https:// 开头的网页地址。',
    ...
    'data_entry.admin_cols_prompt'                => '如果您是管理员，请前往“管理员”→“管理表”以管理列，并为该表至少添加一列。',
    'data_entry.admin_tables_prompt'              => '如果您是管理员，请前往“管理员”→“管理表”以添加表，然后至少添加一列。',
    ...
    'data_entry.date_format_hint'                 => '请使用方框中显示的日期格式。',
    ...
    'data_entry.dup_blocked'                      => '此记录与现有记录过于相似，因此无法添加。',
    'data_entry.dup_close_match'                  => '拼写非常相似',
    'data_entry.dup_confirm_btn'                  => '是的，确认并保存重复项',
    'data_entry.dup_desc'                         => '请检查下方的卡片。如果这是一条不同的记录，您仍然可以选择保存。',
    'data_entry.dup_empty'                        => '（空）',
    'data_entry.dup_flag_btn'                     => '保存并通知管理员',
    'data_entry.dup_heading'                      => '⚠️ 可能重复警告',
    'data_entry.dup_item_format'                  => '记录 ID: %d — 值: %s',
    'data_entry.dup_overview'                     => '已保存',
    'data_entry.dup_prompt'                       => '您是否仍要继续并保存此重复条目？',
    'data_entry.dup_review_btn'                   => '检查我输入的内容',
    'data_entry.dup_score_exact'                  => '计算相似度：%s%。',
    'data_entry.dup_similar'                      => '此项与记录 #%s 的相似度为 %s%%',
    ...
    'data_entry.go_manage_tables'                 => '请前往“管理员”→“管理表”',
    ...
    'data_entry.shortcuts_tip'                    => '💡 提示：按 Ctrl + Enter 提交，或按 Esc 清除当前字段。',
    'data_entry.submit_data_btn'                  => '提交数据',
    'data_entry.th_added_by'                      => '添加者',
    'data_entry.th_date_created'                  => '创建日期',
    'data_entry.time_format_hint'                 => '请使用方框中显示的时间格式。',
    ...
    'setup_2fa.backup_desc'                       => '请将这些备份代码保存在安全的地方。如果丢失了对 2FA 应用的访问权限，每个代码都可以使用一次：',
    ...
    'suggest_edit.dup_of_help'                    => '可选。管理员将看到此备注。',
    'suggest_edit.dup_of_label'                   => '如果您知道另一条记录的编号，可以在此输入',
    'suggest_edit.dup_please_check'               => '此更改将与另一条记录高度相似。请检查下方内容。',
    'suggest_edit.empty_label'                    => '(空)',
    'suggest_edit.err_notify_email'               => '如果您希望获取处理结果，请输入电子邮件地址。',
    'suggest_edit.heading_prefix'                 => '建议编辑记录',
    'suggest_edit.leave_blank'                    => '请将此字段留空',
    'suggest_edit.no_rationale'                   => '未添加额外备注。',
    'suggest_edit.notify_email_help'              => '仅用于通知您处理结果，不会显示在公开记录中。',
    'suggest_edit.notify_email_label'             => '您的电子邮件地址',
    'suggest_edit.notify_label'                   => '当管理员做出决定时向我发送电子邮件',
    ...
    'suggest_edit.report_dup'                     => '我认为这条记录是另一条记录的重复',
