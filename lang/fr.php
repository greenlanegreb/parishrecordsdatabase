...
return [
    ...
    'nav.zoom_group'                              => 'Taille du texte',
    'nav.zoom_in'                                 => 'Texte plus grand',
    'nav.zoom_out'                                => 'Texte plus petit',
    'nav.zoom_reset'                              => 'Réinitialiser la taille du texte',
    ...
    'index.no_public_tables'                      => 'Aucune table n\'est disponible pour le public sur ce site.',
    'record.back'                                 => 'Retour à la liste',
    'record.heading'                              => 'Enregistrement',
    'record.print'                                => 'Imprimer cet enregistrement',
    'record.view'                                 => 'Voir l\'enregistrement',
    'search.export_csv'                           => 'Télécharger les résultats filtrés au format CSV',
    'search.heading'                              => 'Filtres de recherche multicolonnes',
    'search.heading_for'                          => 'pour',
    ...
    // ------------------------------------------------------------------
    'index.admin_add_columns_guide'               => 'En tant qu\'Administrateur, veuillez aller dans Admin → Gérer les tables pour ajouter au moins une colonne à votre table.',
    'index.admin_create_table_guide'              => 'En tant qu\'Administrateur, veuillez aller dans Admin → Gérer les tables pour créer une table, puis ajoutez au moins une colonne à cette table avant que des enregistrements ne puissent être affichés ou saisis.',
    ...
    'index.guest_login_tables_guide'              => 'Veuillez vous connecter en tant qu\'Administrateur et aller dans Admin → Gérer les tables pour créer une table, puis ajoutez au moins une colonne.',
    ...
    // ------------------------------------------------------------------
    'cols.back'                                   => 'Retour',
    'cols.print_btn'                              => 'Imprimer',
    'cols.print_entire'                           => 'Tout imprimer',
    'cols.print_filtered'                         => 'Imprimer les éléments filtrés',
    'cols.print_now'                              => 'Imprimer ou enregistrer au format PDF',
    'cols.show_heading'                           => 'Choisir les colonnes à afficher',
    'cols.show_help'                              => 'Décochez une colonne pour la masquer ici, lors des téléchargements et à l\'impression. Sur un téléphone, il est plus facile de lire un texte avec moins de colonnes.',
    ...
    'manage_tables.edit_metadata_btn'             => 'Modifier les détails de la table',
    'manage_tables.edit_table_summary'            => 'Modifier la définition de la table :',
    'manage_tables.err_col_name_empty'            => 'Veuillez saisir un nom de colonne.',
    'manage_tables.err_col_name_taken'            => 'Cette table possède déjà une colonne nommée %s. Veuillez choisir un autre nom.',
    'manage_tables.err_table_name_empty'          => 'Veuillez saisir un nom de table.',
    'manage_tables.err_table_name_taken'          => 'Il existe déjà une table nommée %s. Veuillez choisir un autre nom.',
    'manage_tables.exclude_search_label'          => 'Exclure cette colonne de la recherche publique',
    'manage_tables.existing_cols_heading_prefix'  => 'Colonnes existantes pour',
    'manage_tables.heading'                       => 'Gestion dynamique des tables et des colonnes',
    'manage_tables.intro'                         => 'Vous pouvez modifier ici les noms, les types de champs et ce qui apparaît sur les listes de recherche ou la page d\'enregistrement unique.',
    ...
    'manage_tables.show_in_list'                  => 'Afficher sur la liste de recherche / saisie de données',
    'manage_tables.show_in_record'                => 'Afficher sur la page d\'enregistrement complet',
    'manage_tables.status_hidden'                 => 'Masqué',
    'manage_tables.subheading'                    => 'Vous pouvez modifier les noms, les types de champs et ce qui apparaît sur la liste de recherche ou la page d\'enregistrement unique.',
    ...
    'manage_tables.type_boolean'                  => 'Booléen (Homme / Femme, Coche / Croix, Vrai / Faux, Oui / Non)',
    'manage_tables.type_choice'                   => 'Liste de choix',
    'manage_tables.type_date'                     => 'Date',
    'manage_tables.type_email'                    => 'Adresse e-mail',
    'manage_tables.type_int'                      => 'Entier (Nombre entier)',
    'manage_tables.type_location'                 => 'Emplacement (Épingle de carte)',
    ...
    'manage_tables.type_text_long'                => 'Texte long',
    'manage_tables.type_time'                     => 'Heure',
    'manage_tables.type_url'                      => 'Adresse Web',
    'manage_tables.type_varchar'                  => 'Texte court',
    'manage_tables.url_new_tab'                   => 'Ouvrir dans un nouvel onglet',
    ...
    'user_emails.desc_outcome'                    => 'Ceci est envoyé lorsqu\'un modérateur accepte ou refuse une modification suggérée et que le soumetteur a demandé à recevoir un e-mail.',
    ...
    'user_emails.opt_suggestion_outcome'          => 'Résultat de la suggestion de modification',
    'user_emails.placeholders_hint'               => 'Ces jetons sont remplis lors de l\'envoi de ce modèle. Seules les cartes ci-dessous s\'appliquent au modèle que vous avez sélectionné.',
    ...
    'dup_merge.confirm'                           => 'Fusionner ces éléments en un seul enregistrement ? L\'autre enregistrement sera supprimé.',
    'dup_merge.fields_caption'                    => 'Choisissez une valeur pour chaque champ',
    'dup_merge.heading'                           => 'Fusionner deux enregistrements similaires',
    'dup_merge.intro'                             => 'Ces deux éléments se ressemblent à environ %s%%. Choisissez l\'enregistrement à conserver, puis sélectionnez une valeur pour chaque champ.',
    'dup_merge.keep_a'                            => 'Conserver l\'enregistrement #%s',
    'dup_merge.keep_b'                            => 'Conserver l\'enregistrement #%s',
    'dup_merge.keep_legend'                       => 'Quel enregistrement doit être conservé ?',
    'dup_merge.save_btn'                          => 'Fusionner en un seul enregistrement',
    'dup_queue.choose_table'                      => 'Choisir une table',
    'dup_queue.col_actions'                       => 'Action',
    'dup_queue.col_records'                       => 'Enregistrements',
    'dup_queue.col_score'                         => 'Degré de similarité',
    'dup_queue.col_table'                         => 'Table',
    'dup_queue.dismiss_btn'                       => 'Ce n\'est pas un doublon',
    'dup_queue.dismissed'                         => 'Cette paire a été marquée comme n\'étant pas un doublon.',
    'dup_queue.empty'                             => 'Aucune attente. Analysez une table pour rechercher d\'éventuels doublons plus anciens.',
    'dup_queue.gone'                              => 'Cet examen n\'est plus en attente.',
    'dup_queue.heading'                           => 'Enregistrements similaires à examiner',
    'dup_queue.intro'                             => 'Analysez une table pour trouver des lignes qui se ressemblent déjà. Vous pouvez indiquer qu\'elles sont différentes ou les fusionner en un seul enregistrement.',
    'dup_queue.merge_btn'                         => 'Fusionner en un seul',
    'dup_queue.merged'                            => 'Ces deux enregistrements n\'en font plus qu\'un. La modification figure dans l\'historique de l\'enregistrement conservé.',
    'dup_queue.scan_btn'                          => 'Analyser cette table',
    'dup_queue.scan_done'                         => 'Analyse terminée. %s paires similaires trouvées, %s nouveaux éléments ajoutés à la liste.',
    'dup_queue.scan_label'                        => 'Rechercher des enregistrements similaires dans',
    ...
    'moderate.dup_approved_note'                  => 'Approuvé. Ceci ressemble désormais à %s%% de l\'enregistrement #%s.',
    'moderate.dup_blocked'                        => 'Approbation impossible : cela ressemblerait à %s%% de l\'enregistrement #%s.',
    ...
    'moderate.rationale_label'                    => 'Note pour la personne ayant fait cette suggestion',
    'moderate.rationale_optional'                 => 'Note facultative (conservée sur l\'enregistrement).',
    'moderate.rationale_placeholder'              => 'Pourquoi vous avez accepté ou refusé cette modification',
    'moderate.rationale_will_be_sent'             => 'La personne a demandé à recevoir un e-mail. Votre note ci-dessous sera envoyée telle quelle, veuillez donc garder un ton courtois et clair.',
    ...
    'moderate.tab_similar'                        => 'Enregistrements similaires',
    ...
    // ------------------------------------------------------------------
    'appearance.add_link'                         => 'Ajouter un lien',
    'appearance.brand_heading'                    => 'Logo et slogan',
    'appearance.colors_heading'                   => 'Couleurs',
    'appearance.colors_help'                      => 'Le contraste élevé remplace toujours ces options lorsqu\'une personne utilise ce commutateur.',
    'appearance.custom_heading'                   => 'Liens personnalisés',
    'appearance.custom_help'                      => 'N\'hésitez pas à en ajouter autant que nécessaire. Veuillez définir le parent pour imbriquer un lien sous un autre en-tête ou sous un menu intégré tel qu\'Admin. Veuillez utiliser # comme adresse pour un en-tête qui n\'est qu\'un titre.',
    'appearance.custom_label'                     => 'Libellé',
    'appearance.custom_parent'                    => 'Parent',
    'appearance.custom_url'                       => 'Adresse',
    'appearance.custom_who'                       => 'Qui peut le voir',
    'appearance.drag'                             => 'Veuillez glisser pour réorganiser',
    'appearance.nav_heading'                      => 'Navigation',
    'appearance.nav_help'                         => 'Vous pouvez faire glisser la poignée pour réorganiser les liens intégrés et personnalisés ensemble. Pour placer un lien sous Admin (ou un autre en-tête), veuillez définir le parent sur ce lien. L\'adresse # crée un en-tête sans page propre. La connexion et le profil restent à leur position intégrée.',
    'appearance.new_tab'                          => 'Nouvel onglet',
    'appearance.parent_builtin'                   => 'Menus intégrés',
    'appearance.parent_custom'                    => 'Vos en-têtes',
    'appearance.parent_none'                      => 'Niveau supérieur — Élément de menu personnel',
    'appearance.remove_link'                      => 'Supprimer',
    'appearance.reset'                            => 'Réinitialiser par défaut',
    'appearance.reset_ok'                         => 'Apparence réinitialisée à l\'aspect par défaut.',
    'appearance.save'                             => 'Enregistrer l\'apparence',
    ...
    'settings.cron_command_label'                 => 'Voici la commande à coller dans vos tâches Cron (Une fois par jour, c\'est parfait !)',
    'settings.cron_exec_ok'                       => 'Cette page a été autorisée à tester PHP à partir d\'ici (facultatif)',
    'settings.cron_maintenance_desc'              => 'pRD a analysé automatiquement votre serveur Web et suggère une commande nocturne. Vous devez tout de même la coller dans vos tâches Cron. Vous pouvez également lancer un nettoyage dès maintenant.',
    'settings.cron_maintenance_heading'           => 'Maintenance automatisée des jetons et configuration Cron',
    'settings.cron_php_ok'                        => 'Commande PHP trouvée',
    'settings.cron_script_ok'                     => 'Félicitations - Votre script de nettoyage est en place !',
    ...
    'settings.dup_heading'                        => 'Gestion des enregistrements en doublon',
    'settings.dup_help'                           => 'pRD compare le texte saisi aux autres lignes de la même table. Vous pouvez avertir les utilisateurs, bloquer l\'enregistrement ou désactiver cette fonction.',
    'settings.dup_legend'                         => 'Si un nouvel enregistrement ressemble à un autre que vous possédez déjà',
    'settings.dup_mode_block'                     => 'Ne pas autoriser l\'enregistrement',
    'settings.dup_mode_flag'                      => 'Avertir l\'utilisateur et le signaler à un modérateur s\'il enregistre malgré tout',
    'settings.dup_mode_off'                       => 'Ne pas vérifier les enregistrements similaires',
    'settings.dup_mode_warn'                      => 'Afficher un avertissement — l\'enregistrement reste possible',
    'settings.dup_picky_exact'                    => 'Uniquement lorsque les mots correspondent étroitement',
    'settings.dup_picky_label'                    => 'Quel doit être le niveau de rigueur de la vérification ?',
    'settings.dup_picky_similar'                  => 'Détecter également les quasi-correspondances (orthographe similaire)',
    ...
    'settings.map_tile_api_key_help'              => 'Ceci est nécessaire pour CARTO, Mapbox ou Stadia. Veuillez laisser vide pour conserver une clé existante. L\'OpenStreetMap par défaut ne nécessite pas de clé.',
    'settings.map_tile_carto'                     => 'CARTO Voyager (Clé gratuite disponible sur carto.com/basemaps/apikey)',
    'settings.map_tile_custom'                    => 'URL de tuile personnalisée',
    'settings.map_tile_default'                   => 'Par défaut gratuit (OpenStreetMap)',
    ...
    'settings.mod_leaderboard_desc'               => 'Reconnaît les efforts de transcription et tient les comptes.',
    ...
    'settings.mod_maps_desc'                      => 'Affiche une carte géographique pour chaque table qui possède une colonne de localisation dynamique.',
    ...
    'settings.perm_locked'                        => 'Cette permission est obligatoire pour les administrateurs.',
    'settings.perm_more_info'                     => 'En savoir plus sur',
    'settings.perm_needs'                         => 'Nécessite',
    'settings.perm_needs_parent'                  => 'Veuillez d\'abord activer cette option.',
    'settings.perm_no_links'                      => 'Cette permission ne dépend d\'aucune autre.',
    'settings.perm_save_failed'                   => 'Désolé - pRD n\'a pas pu enregistrer ce paramètre.',
    'settings.perm_saved'                         => 'Enregistré',
    'settings.perm_swipe'                         => 'Sur un petit écran, veuillez faire glisser cette liste horizontalement si nécessaire.',
    'settings.perm_used_by'                       => 'Requis par',
    ...
    'settings.subheading'                         => 'Gérer l\'apparence, la configuration principale, les pilotes de messagerie, les options de sécurité/CAPTCHA, les modules, le mode maintenance, les annonces du site et les capacités des rôles.',
    ...
    'update_database.emergency_active'            => 'L\'accès à la mise à jour de la base de données est ouvert pour vous permettre de terminer cette étape sans vous connecter. Il se fermera automatiquement lorsque la base de données sera à jour.',
    'updates.already_current'                     => 'Les fichiers correspondent déjà au canal de mise à jour sélectionné. Rien n\'a été modifié.',
    'updates.apply_btn'                           => 'Appliquer le paquet de fichiers',
    'updates.archive_failed'                      => 'Désolé - pRD n\'a pas pu écrire la copie privée de la base de données. La mise à jour des fichiers n\'a pas démarré.',
    'updates.archive_missing'                     => 'Désolé - cette sauvegarde privée est introuvable.',
    'updates.channel_help'                        => 'Veuillez ne pas modifier le canal de mise à jour à moins d\'être un développeur. Les développeurs peuvent placer une balise ou une référence de commit dans cette case.',
    'updates.channel_label'                       => 'Canal de mise à jour (doit généralement rester sur « Main »)',
    'updates.channel_saved'                       => 'Canal de mise à jour enregistré.',
    'updates.confirm'                             => 'Souhaitez-vous appliquer le paquet de fichiers maintenant ? Ne vous inquiétez pas, vos enregistrements sont conservés. Veuillez d\'abord télécharger une copie de votre base de données si ce n\'est pas déjà fait.',
    'updates.db_behind'                           => 'Base de données : Une mise à jour est en attente',
    'updates.db_pending'                          => 'Si pRD vous demande de mettre à jour la base de données ensuite, veuillez ouvrir cette page. Vous n\'avez pas besoin de créer de fichiers supplémentaires.',
    'updates.db_ran'                              => 'La base de données a également été mise à jour.',
    'updates.download_heading'                    => 'Téléchargement de votre base de données..',
    'updates.download_please'                     => 'Veuillez d\'abord télécharger votre base de données. Conservez votre propre copie ainsi que la copie privée du serveur.',
    'updates.files_behind'                        => 'Fichiers : Un paquet plus récent est disponible',
    'updates.files_current'                       => 'Fichiers : À jour avec le canal de mise à jour sélectionné',
    'updates.files_error'                         => 'Fichiers : Désolé, pRD n\'a pas pu vérifier GitHub pour le moment. Veuillez réessayer plus tard.',
    'updates.files_ok'                            => 'Félicitations ! Paquet de fichiers appliqué.',
    'updates.files_unknown'                       => 'Fichiers : Non vérifié pour l\'instant (veuillez appliquer un paquet une fois pour démarrer le suivi)',
    'updates.force_apply'                         => 'Remplacer les fichiers quand même (uniquement si quelque chose semble endommagé)',
    'updates.heading'                             => 'Mises à jour des fichiers',
    'updates.help'                                => 'Veuillez d\'abord télécharger votre base de données. pRD conserve également une copie privée sur le serveur. La mise à jour des fichiers ne modifie pas les enregistrements. Une fois les fichiers mis à jour, veuillez utiliser « Mettre à jour la base de données » si une version plus récente de la base de données est en attente.',
    'updates.no_sha'                              => 'Aucun paquet enregistré pour l\'instant',
    'updates.now_db'                              => 'Si la version de la base de données est en retard, veuillez utiliser « Mettre à jour la base de données » ensuite.',
    'updates.page_heading'                        => 'Mise à jour de pRD',
    'updates.private_copies'                      => 'Copies privées du serveur (admin uniquement)',
    'updates.running'                             => 'Ce site est en cours d\'exécution',
    ...
    'admin_users.not_verified_badge'              => 'Non vérifié',
    ...
    'admin_users.reset_2fa_btn'                   => 'Désactiver la 2FA',
    ...
    'admin_users.verified_badge'                  => 'Vérifié',
    ...
    'install.admin_subheading'                    => 'Il s\'agit des identifiants de connexion pour ce site Web (et non pour la base de données).',
    'install.admin_username_label'                => 'Nom d’utilisateur administrateur',
    'install.back_btn'                            => 'Retour',
    'install.close_alert'                         => 'Fermer',
    'install.complete_desc'                       => 'Votre installation de pRD est maintenant configurée et le programme d\'installation est verrouillé pour ne pas pouvoir être réexécuté par erreur.',
    'install.complete_heading'                    => 'Félicitations !',
    ...
    'install.db_hint'                             => 'Veuillez utiliser les détails MySQL fournis par le panneau de contrôle de votre hébergement. Il ne s\'agit pas de la connexion administrateur du site Web (qui interviendra juste après).',
    ...
    'install.delete_folder_hint'                  => 'De nombreux hébergeurs Web ne permettent pas au programme d\'installation de supprimer son propre dossier. Si le bouton ne fait rien, veuillez ouvrir le gestionnaire de fichiers de votre hébergement Web ou FTP, aller dans votre dossier de projet pRD, et supprimer ou renommer le répertoire d\'installation sur place.',
    ...
    'install.mod_feedback'                        => 'Soumissions de commentaires',
    'install.mod_feedback_desc'                   => 'Active un formulaire de commentaires public et un tableau de bord de suivi d\'administration.',
    'install.mod_leaderboard'                     => 'Classement et gamification',
    'install.mod_leaderboard_desc'                => 'Tableau de points optionnel. Nécessite l\'activation des comptes utilisateurs.',
    ...
    'install.mod_moderation'                      => 'Flux de travail de modération',
    'install.mod_moderation_desc'                 => 'Un système de flux de travail de modération qui permet aux utilisateurs de suggérer des modifications et à un modérateur d\'approuver ou de refuser la suggestion.',
    'install.mod_users'                           => 'Gestion des utilisateurs et accès multi-utilisateurs',
    'install.mod_users_desc'                      => 'Permettre aux utilisateurs de s\'inscrire et de se connecter.',
    'install.mod_volunteers'                      => 'Portail des bénévoles et soumissions',
    'install.mod_volunteers_desc'                 => 'Active un formulaire d\'intérêt public pour les bénévoles et un tableau de bord de gestion d\'administration.',
    'install.modules_continue'                    => 'Enregistrer et continuer',
    'install.modules_heading'                     => 'Quelles parties de pRD souhaitez-vous utiliser ?',
    'install.modules_help'                        => 'Veuillez cocher les fonctionnalités souhaitées dès le premier jour. Vous pourrez modifier ce choix ultérieurement dans Admin → Paramètres du site.',
    'install.modules_later'                       => 'Vous pouvez activer ou désactiver l\'un de ces modules plus tard dans Admin → Paramètres du site.',
    ...
    'install.msg_modules_saved'                   => 'Vos choix de modules ont été enregistrés. Vous pouvez ajouter des packs de démonstration optionnels ou ignorer cette étape si vous préférez.',
    ...
    'install.remove_already_gone'                 => 'Le dossier d\'installation a déjà été supprimé.',
    'install.remove_failed'                       => 'Désolé - pRD n\'a pas pu supprimer automatiquement le dossier d\'installation (les serveurs Web ne le permettent souvent pas). Dans le gestionnaire de fichiers de votre hébergement Web ou via FTP, veuillez ouvrir le dossier pRD et supprimer ou renommer le répertoire d\'installation qu\'il contient.',
    'install.remove_folder_btn'                   => 'Veuillez supprimer le dossier d\'installation !',
    'install.remove_ok'                           => 'Le dossier d\'installation a été supprimé.',
    ...
    'footer.software_notice'                      => 'pRD (V1.18) est un logiciel libre sous licence MIT - Merci à @katherinehuk sur GitHub pour son double regard !',
    ...
    'save_data_entry.err_email'                   => 'Veuillez entrer une adresse e-mail valide pour %s.',
    ...
    'save_data_entry.err_url'                     => 'Veuillez entrer une adresse Web commençant par http:// ou https:// pour %s.',
    ...
    'data_entry.admin_cols_prompt'                => 'Si vous êtes Administrateur, veuillez aller dans Admin → Gérer les tables pour gérer les colonnes et ajouter au moins une colonne à cette table.',
    'data_entry.admin_tables_prompt'              => 'Si vous êtes Administrateur, veuillez aller dans Admin → Gérer les tables pour ajouter une table, puis ajoutez au moins une colonne.',
    ...
    'data_entry.date_format_hint'                 => 'Veuillez utiliser le format de date affiché dans la case.',
    ...
    'data_entry.dup_blocked'                      => 'Cet enregistrement est trop similaire à un autre déjà enregistré et ne peut donc pas être ajouté.',
    'data_entry.dup_close_match'                  => 'Orthographe très similaire',
    'data_entry.dup_confirm_btn'                  => 'Oui, confirmer et enregistrer le doublon',
    'data_entry.dup_desc'                         => 'Veuillez vérifier les cartes ci-dessous. Vous pouvez tout de même enregistrer s\'il s\'agit d\'un enregistrement différent.',
    'data_entry.dup_empty'                        => '(vide)',
    'data_entry.dup_flag_btn'                     => 'Enregistrer et avertir un modérateur',
    'data_entry.dup_heading'                      => '⚠️ Avertissement de doublon potentiel',
    'data_entry.dup_item_format'                  => 'ID d’enregistrement : %d — Valeur : %s',
    'data_entry.dup_overview'                     => 'Déjà enregistré',
    'data_entry.dup_prompt'                       => 'Souhaitez-vous tout de même continuer et enregistrer ce doublon ?',
    'data_entry.dup_review_btn'                   => 'Vérifier ce que j\'ai tapé',
    'data_entry.dup_score_exact'                  => 'Similarité calculée : %s pour cent.',
    'data_entry.dup_similar'                      => 'Ceci ressemble à %s%% de l\'enregistrement #%s',
    ...
    'data_entry.go_manage_tables'                 => 'Veuillez aller dans Admin → Gérer les tables',
    ...
    'data_entry.shortcuts_tip'                    => '💡 Conseils : Appuyez sur Ctrl + Entrée pour valider, ou sur Échap pour effacer le champ actuel.',
    ...
    'data_entry.time_format_hint'                 => 'Veuillez utiliser le format d\'heure affiché dans la case.',
    ...
    'profile.setup_tfa_btn'                       => 'Configurer la 2FA',
    ...
    'setup_2fa.backup_desc'                       => 'Veuillez conserver ces codes de secours dans un endroit sûr. Chaque code ne peut être utilisé qu\'une seule fois si vous perdez l\'accès à votre application 2FA :',
    ...
    'setup_2fa.heading'                           => 'Configurer la 2FA',
    ...
    'suggest_edit.decision_accepted'              => 'Accepté',
    'suggest_edit.decision_not_accepted'          => 'Refusé',
    'suggest_edit.dup_of_help'                    => 'Facultatif. Les modérateurs verront cette note.',
    'suggest_edit.dup_of_label'                   => 'Si vous connaissez le numéro de l\'autre enregistrement, vous pouvez l\'ajouter ici',
    'suggest_edit.dup_please_check'               => 'Cette modification serait très similaire à un autre enregistrement. Veuillez vérifier ci-dessous.',
    'suggest_edit.empty_label'                    => '(vide)',
    'suggest_edit.err_notify_email'               => 'Veuillez saisir une adresse e-mail si vous souhaitez être informé du résultat.',
    ...
    'suggest_edit.no_rationale'                   => 'Aucune note supplémentaire n\'a été ajoutée.',
    'suggest_edit.notify_email_help'              => 'Utilisée uniquement pour vous informer du résultat. Elle n\'est pas affichée sur l\'enregistrement public.',
    'suggest_edit.notify_email_label'             => 'Votre adresse e-mail',
    'suggest_edit.notify_label'                   => 'M\'envoyer un e-mail lorsqu\'un modérateur aura pris une décision',
    ...
    'suggest_edit.report_dup'                     => 'Je pense que cet enregistrement est un doublon d\'un autre',
