...
return [
    ...
    'nav.zoom_group'                              => 'د متن اندازه',
    'nav.zoom_in'                                 => 'غټ متن',
    'nav.zoom_out'                                => 'کوچنی متن',
    'nav.zoom_reset'                              => 'د متن اندازې بیا تنظیمول',
    ...
    'index.no_public_tables'                      => 'په دې سایټ کې د عامو خلکو لپاره هیڅ جدول نشته.',
    'record.back'                                 => 'فهرست ته ستنیدل',
    'record.heading'                              => 'ریکارډ',
    'record.print'                                => 'دا ریکارډ چاپول',
    'record.view'                                 => 'ریکارډ لیدل',
    'search.export_csv'                           => 'فلټر شوي پایلې د CSV په بڼه راښکته کول',
    'search.heading'                              => 'د څو ستنو ګډه پلټنه',
    'search.heading_for'                          => 'د',
    ...
    'cols.print_entire'                           => 'ټول چاپول',
    'cols.print_filtered'                         => 'فلټر شوي چاپول',
    ...
    'feedback_dash.th_ticket_date'                => 'نیټه',
    ...
    'manage_tables.edit_metadata_btn'             => 'د جدول تفصیلي معلومات سمول',
    ...
    'manage_tables.exclude_search_label'          => 'دا ستون د عام لټون څخه وباسئ',
    'manage_tables.existing_cols_heading_prefix'  => 'شته ستنې:',
    'manage_tables.heading'                       => 'د متحرک جدول او ستون مدیریت',
    'manage_tables.intro'                         => 'دلته تاسو کولی شئ نومونه، د ساحې ډولونه، او هغه څه بدل کړئ چې د لټون په لستونو یا ځانګړي ریکارډ پاڼه کې ښکاري.',
    ...
    'manage_tables.req_toggle_label'              => 'دا ستون لازمي ګرځول (د معلوماتو اجباري داخلول)',
    'manage_tables.save_and_add_col'              => 'خوندي کول او بل اضافه کول',
    'manage_tables.save_table_btn'                => 'د جدول بدلونونه خوندي کول',
    'manage_tables.show_in_list'                  => 'د لټون / ډیټا داخلولو په لست کې ښودل',
    'manage_tables.show_in_record'                => 'د بشپړ ریکارډ په پاڼه کې ښودل',
    'manage_tables.status_hidden'                 => 'پټ',
    'manage_tables.subheading'                    => 'تاسو کولی شئ نومونه، د ساحې ډولونه، او هغه څه بدل کړئ چې د لټون په لست یا ځانګړي ریکارډ پاڼه کې ښکاري.',
    ...
    'user_emails.desc_outcome'                    => 'دا هغه وخت لیږل کیږي کله چې یو مدیر وړاندیز شوی سمون ومني یا رد کړي او استونکي د بریښنالیک غوښتنه کړې وي.',
    ...
    'user_emails.placeholders_hint'               => 'دا ټوکنونه د دې قالب د لیږلو په وخت کې ډکیږي. یوازې لاندې کارډونه په هغه قالب تطبیق کیږي چې تاسو غوره کړی دی.',
    ...
    'appearance.saved'                            => 'ظاهري بڼه خوندي شوه.',
    'appearance.type_heading'                     => 'ډول',
    ...
    'settings.map_tile_api_key_help'              => 'دا د CARTO، Mapbox یا Stadia لپاره اړین دی. مهرباني وکړئ د موجوده کیلي ساتلو لپاره تش پاتې شئ. اصلي OpenStreetMap کیلي ته اړتیا نلري.',
    'settings.map_tile_carto'                     => 'CARTO Voyager (وړیا کیلي د carto.com/basemaps/apikey څخه ترلاسه کیږي)',
    'settings.map_tile_custom'                    => 'د ګمرکي ټایل URL',
    'settings.map_tile_default'                   => 'وړیا اصلي حالت (OpenStreetMap)',
    ...
    'settings.mod_leaderboard_desc'               => 'د لیکلو هڅې پیژني او نمرې ساتی.',
    'settings.mod_leaderboard_note'               => '(د کاروونکو مدیریت او څو کاروونکي لاسرسي ته اړتیا لري)',
    'settings.mod_maps'                           => 'نقشې',
    'settings.mod_maps_desc'                      => 'د هر هغه جدول لپاره جغرافیایي نقشه وښایئ چې د متحرک موقعیت ستون لري.',
    ...
    'settings.perm_save_failed'                   => 'بخښنه غواړو - pRD ونشو کولی دا تنظیم خوندي کړي.',
    'settings.perm_saved'                         => 'خوندي شو',
    'settings.perm_swipe'                         => 'په کوچني سکرین کې، که ورته اړتیا وي مهرباني وکړئ دا لست په افقی ډول وښویوئ (Swipe).',
    ...
    'settings.subheading'                         => 'د ظاهري بڼې، اصلي ترتیب، د بریښنالیک ډرایورانو، د امنیت/CAPTCHA اختیارونو، ماډلونو، د ساتنې حالت، د سایټ اعلانونو، او د رول د صلاحیتونو اداره کول.',
    'settings.sys_name_label'                     => 'د سیستم / غوښتنلیک نوم:',
    'settings.system_guest'                       => 'سیستم / مېلمه',
    'settings.tab_appearance'                     => 'ظاهري بڼه',
    ...
    'update_database.emergency_active'            => 'د ډیټابیس د تازه کولو لاسرسی پرانیستی دی ترڅو تاسو وکولی شئ دا ګام پرته له ننوتلو پای ته ورسوئ. کله چې ډیټابیس تازه شي، دا به په خپله وتړل شي.',
    'updates.already_current'                     => 'فایلونه دمخه د ټاکل شوي تازه کولو چینل سره سمون لري. هیڅ شی ونه بدل شو.',
    'updates.apply_btn'                           => 'د فایل کڅوړه پلي کول',
    'updates.archive_failed'                      => 'بخښنه غواړو - pRD ونشو کولی د ډیټابیس شخصي کاپي وליکي. د فایل تازه کول پیل نشول.',
    'updates.archive_missing'                     => 'بخښنه غواړو - هغه شخصي بیک اپ ونه موندل شو.',
    'updates.channel_help'                        => 'مهرباني وکړئ د تازه کولو چینل مه بدلوئ مګر دا چې تاسو پرمخوړونکی (Developer) یاست. پرمخوړونکي کولی شي پدې بکس کې یو ټاګ یا د کمټ حواله واچوي.',
    'updates.channel_label'                       => 'د تازه کولو چینل (دا باید عموماً په «Main» پاتې شي)',
    'updates.channel_saved'                       => 'د تازه کولو چینل خوندي شو.',
    'updates.confirm'                             => 'آیا غواړئ اوس د فایل کڅوړه پلي کړئ؟ اندیښنه مه کوئ، ستاسو ریکارډونه خوندي پاتې کیږي. که تاسو تر اوسه نه وي کړي، مهرباني وکړئ لومړی د خپل ډیټابیس یوه کاپي ډاونلوډ کړئ.',
    'updates.db_behind'                           => 'ډیټابیس: یو تازه معلومات په تمه دی',
    'updates.db_pending'                          => 'که pRD له تاسو وغواړي چې راتلونکی ډیټابیس تازه کړئ، مهرباني وکړئ هغه پاڼه پرانیزئ. تاسو اړتیا نلرئ کوم اضافي فایلونه جوړ کړئ.',
    'updates.db_ran'                              => 'ډیټابیس هم تازه شو.',
    'updates.download_heading'                    => 'د ډیټابیس ډاونلوډ کیدل..',
    'updates.download_please'                     => 'مهرباني وکړئ لومړی خپل ډیټابیس ډاونلوډ کړئ. مهرباني وکړئ خپله شخصي کاپي او همدارنګه د سرور شخصي کاپي وساتئ.',
    'updates.files_behind'                        => 'فایلونه: نوې کڅوړه شتون لري',
    'updates.files_current'                       => 'فایلونه: د ټاکل شوي تازه کولو چینل سره همغږي او تازه دي',
    'updates.files_error'                         => 'فایلونه: بخښنه غواړو، pRD اوس مهال نشي کولی ګیټ هب (GitHub) وڅاري. مهرباني وکړئ وروسته بیا هڅه وکړئ.',
    'updates.files_ok'                            => 'مبارک شه! د فایل کڅوړه پلي شوه.',
    'updates.files_unknown'                       => 'فایلونه: لا تر اوسه نه دي څارل شوي (مهرباني وکړئ د تعقیب پیل کولو لپاره یو ځل کڅوړه پلي کړئ)',
    'updates.force_apply'                         => 'په هر حال د فایلونو ځای ناستی کول (یوازې که یو شی خراب ښکاري)',
    'updates.heading'                             => 'د فایل تازه معلومات',
    'updates.help'                                => 'مهرباني وکړئ لومړی خپل ډیټابیس ډاونلوډ کړئ. pRD همدارنګه په سرور کې یو شخصي کاپي ساتي. د فایل تازه کول ریکارډونه نه بدلوي. د فایلونو له تازه کیدو وروسته، که د ډیټابیس نوې نسخه په تمه وي، مهرباني وکړئ «ډیټابیس تازه کړئ» وکاروئ.',
    'updates.no_sha'                              => 'تر اوسه کومه کڅوړه نه ده ثبت شوې',
    'updates.now_db'                              => 'که د ډیټابیس نسخه وروسته پاتې وي، مهرباني وکړئ وروسته «ډیټابیس تازه کړئ» وکاروئ.',
    'updates.page_heading'                        => 'د pRD تازه کول',
    'updates.private_copies'                      => 'د سرور شخصي کاپيګانې (یوازې د مدیر لپاره)',
    'updates.running'                             => 'دا سایټ فعال دی',
    ...
    'admin_users.not_verified_badge'              => 'نا تایید شوی',
    ...
    'admin_users.reset_2fa_btn'                   => 'دوه پړاوه تایید (2FA) بندول',
    ...
    'admin_users.verified_badge'                  => 'تایید شوی',
    ...
    'install.complete_desc'                       => 'ستاسو د pRD نصبول اوس تنظیم شوي او نصب کونکی لاک شوی ترڅو په تېروتنه بیا ونه چلول شي.',
    'install.complete_heading'                    => 'مبارک شه!',
    ...
    'install.delete_folder_hint'                  => 'د ویب ډیری کوربه توبونه (Hosts) به د نصب کونکي ته اجازه ورنکړي چې خپل پوښلر حذف کړي. که تڼۍ څه ونه کړي، مهرباني وکړئ د خپل ویب هوسټنګ فایل مینیجر یا FTP پرانیزئ، خپل د pRD پروژې پوښلر ته لاړ شئ، او هلته د نصبولو ډایرکټري حذف یا یې نوم بدل کړئ.',
    ...
    'install.mod_feedback'                        => 'د نظرونو سپارل',
    'install.mod_feedback_desc'                   => 'د عامه نظرونو فورمې او د مدیر تعقیب داشبورد فعالوي.',
    'install.mod_leaderboard'                     => 'د مخکښانو جدول او ګیمیفیکیشن',
    ...
    'install.mod_moderation'                      => 'د تعدیل کار جریان',
    'install.mod_moderation_desc'                 => 'د تعدیل د کار جریان یو سیسټم چې کاروونکو ته اجازه ورکوي سمونونه وړاندیز کړي او مدیر ته اجازه ورکړي چې وړاندیز تایید یا رد کړي.',
    'install.mod_users'                           => 'د کاروونکو اداره او څو-کاروونکي لاسرسی',
    'install.mod_users_desc'                      => 'خلکو ته اجازه ورکول چې نوم لیکنه وکړي او دننه شي.',
    'install.mod_volunteers'                      => 'د رضاکارانو پورټل او سپارنې',
    'install.mod_volunteers_desc'                 => 'د رضاکارانو د لیوالتیا عامه فورمه او د مدیریت داشبورد فعالوي.',
    ...
    'install.modules_later'                       => 'تاسو کولی شئ د دې ماډلونو څخه کوم یو وروسته د مدیریت ← د سایټ تنظیماتو کې فعال یا بند کړئ.',
    ...
    'install.msg_modules_saved'                   => 'ستاسو د ماډل ټاکنې خوندي شوې. تاسو کولی شئ اختیاري ډیمو کڅوړې اضافه کړئ، یا که وغواړئ دا ګام پریږدئ.',
    ...
    'install.remove_already_gone'                 => 'د نصبولو پوښلر دمخه لرې شوی دی.',
    'install.remove_failed'                       => 'بخښنه غواړو - pRD ونشو کولی د نصبولو پوښلر په اتوماتيک ډول حذف کړي (د ویب سرورونه معمولا اجازه نه ورکوي). د خپل ویب هوسټنګ فایل مینیجر کې یا د FTP له لارې، مهرباني وکړئ د pRD پوښلر پرانیزئ او دننه د نصبولو ډایرکټري حذف یا یې نوم بدل کړئ.',
    'install.remove_folder_btn'                   => 'مهرباني وکړئ د لګولو پوښۍ لرې کړئ!',
    'install.remove_ok'                           => 'د نصبولو پوښلر (فولډر) لرې شو.',
    ...
    'data_entry.date_format_hint'                 => 'مهرباني وکړئ په بکس کې ښودل شوی د نیټې فارمیټ وکاروئ.',
    ...
    'data_entry.time_format_hint'                 => 'مهرباني وکړئ په بکس کې ښودل شوی د وخت فارمیټ وکاروئ.',
