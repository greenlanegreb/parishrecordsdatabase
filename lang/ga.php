...
return [
    ...
    'nav.welcome'                                 => 'Fáilte,',
    'nav.zoom_group'                              => 'Méid Téacs',
    'nav.zoom_in'                                 => 'Téacs Níos Mó',
    'nav.zoom_out'                                => 'Téacs Níos Lú',
    'nav.zoom_reset'                              => 'Athshocraigh Méid an Téacs',
    ...
    'index.no_public_tables'                      => 'Níl Aon Tábla Ar Fáil don Phobal ar an Suíomh Seo.',
    'record.back'                                 => 'Ar Ais go dtí an Liosta',
    'record.heading'                              => 'Taifead',
    'record.print'                                => 'Priontáil an Taifead Seo',
    'record.view'                                 => 'Féach ar an Taifead',
    'search.export_csv'                           => 'Íoslódáil na torthaí scagtha mar CSV',
    'search.heading'                              => 'Scagairí Cuardaigh Ilcholúin',
    'search.heading_for'                          => 'do',
    ...
    // ------------------------------------------------------------------
    'index.admin_add_columns_guide'               => 'Mar Riarthóir, téigh go Riarthóir → Bainistigh Táblaí chun colún amháin ar a laghad a chur le do thábla.',
    'index.admin_create_table_guide'              => 'Mar Riarthóir, téigh go Riarthóir → Bainistigh Táblaí chun tábla a chruthú, agus ansin cuir colún amháin ar a laghad leis an tábla sin sular féidir taifid a thaispeáint nó a iontráil.',
    ...
    'index.guest_login_tables_guide'              => 'Logáil isteach mar Riarthóir le do thoil agus téigh go Riarthóir → Bainistigh Táblaí chun tábla a chruthú, agus ansin cuir colún amháin ar a laghad leis.',
    ...
    // ------------------------------------------------------------------
    'cols.back'                                   => 'Ar ais',
    'cols.print_btn'                              => 'Priontáil',
    'cols.print_entire'                           => 'Priontáil Uile',
    'cols.print_filtered'                         => 'Priontáil Scagtha',
    'cols.print_now'                              => 'Priontáil nó sábháil mar PDF',
    'cols.show_heading'                           => 'Roghnaigh na colúin le theaspáint',
    'cols.show_help'                              => 'Díthiceáil colún chun é a fh userRoutes yma, le linn íoslódála, agus nuair a dhéantar priontáil. Ar ghuthán, is fusa colúin níos lú a léamh.',
    ...
    'feedback_dash.th_ticket_date'                => 'Dáta',
    ...
    'manage_tables.edit_metadata_btn'             => 'Eagar Sonraí Tábla',
    'manage_tables.edit_table_summary'            => 'Eagraigh sainmhíniú an tábla:',
    'manage_tables.err_col_name_empty'            => 'Cuir isteach ainm colúin, le do thoil.',
    'manage_tables.err_col_name_taken'            => 'Tá colún darb ainm %s ag an tábla seo cheana féin. Roghnaigh ainm difriúil, le do thoil.',
    'manage_tables.err_table_name_empty'          => 'Cuir isteach ainm tábla, le do thoil.',
    'manage_tables.err_table_name_taken'          => 'Tá tábla ann cheana féin darb ainm %s. Roghnaigh ainm difriúil, le do thoil.',
    'manage_tables.exclude_search_label'          => 'Eisigh an Colún Seo ó Chuardach Poiblí',
    'manage_tables.existing_cols_heading_prefix'  => 'Colúin atá ann cheana le haghaidh',
    'manage_tables.heading'                       => 'Bainistíocht Dinimiciúil Tábla & Colún',
    'manage_tables.intro'                         => 'Is Féidir Leat Ainmneacha, Cineálacha Réimsí, agus Cad a Thaispeántar ar na Liostaí Cuardaigh nó ar an Leathanach Taifid Aonair a Athrú Anseo.',
    ...
    'manage_tables.show_in_list'                  => 'Taispeáin ar an Liosta Cuardaigh / Iontrála Sonraí',
    'manage_tables.show_in_record'                => 'Taispeáin ar an Leathanach Taifid Iomláin',
    'manage_tables.status_hidden'                 => 'Faoi rún',
    'manage_tables.subheading'                    => 'Is Féidir Leat Ainmneacha, Cineálacha Réimsí, agus Cad a Thaispeántar ar an Liosta Cuardaigh nó ar an Leathanach Taifid Aonair a Athrú.',
    ...
    'manage_tables.type_boolean'                  => 'Booleach (Fireann / Mná, Tic / Cros, Fíor / Bréagach, Tá / Níl)',
    'manage_tables.type_choice'                   => 'Liosta Roghnúcháin',
    'manage_tables.type_date'                     => 'Dáta',
    'manage_tables.type_email'                    => 'Seoladh Ríomhphoist',
    'manage_tables.type_int'                      => 'Slánuimhir',
    'manage_tables.type_location'                 => 'Suíomh (Pin Mapa)',
    ...
    'manage_tables.type_text_long'                => 'Téacs Fada',
    'manage_tables.type_time'                     => 'Am',
    'manage_tables.type_url'                      => 'Seoladh Gréasáin',
    'manage_tables.type_varchar'                  => 'Téacs Gearr',
    'manage_tables.url_new_tab'                   => 'Oscail i gCluaisín Nua',
    ...
    'user_emails.desc_outcome'                    => 'Seoltar é seo nuair a ghlacann Modhnóir le Eagar Molta nó nuair a Dhiúltaíonn siad dó agus gur iarr an Seoltóir Ríomhphost a fháil.',
    ...
    'user_emails.opt_suggestion_outcome'          => 'Toradh an molta eagair',
    'user_emails.placeholders_hint'               => 'Líonadh na Comharthaí seo nuair a Sheoltar an Teimpléad Seo. Níl ach na Cártaí thíos i bhfeidhm ar an Teimpléad a Roghnaigh Tú.',
    ...
    // ------------------------------------------------------------------
    'dup_merge.col_a'                             => 'Taifead #%s',
    'dup_merge.col_b'                             => 'Taifead #%s',
    'dup_merge.col_field'                         => 'Réimse',
    'dup_merge.confirm'                           => 'An dteastaíonn uait iad seo a aontú in aon taifead amháin? Bainfear an taifead eile.',
    'dup_merge.fields_caption'                    => 'Roghnaigh luach do gach réimse',
    'dup_merge.heading'                           => 'Aontaigh dhá thaifead chosúla',
    'dup_merge.intro'                             => 'Tá an dá cheann seo thart ar %s%% cosúil. Roghnaigh cén taifead le coinneáil, ansin roghnaigh luach do gach réimse.',
    'dup_merge.keep_a'                            => 'Coinnigh taifead #%s',
    'dup_merge.keep_b'                            => 'Coinnigh taifead #%s',
    'dup_merge.keep_legend'                       => 'Cén taifead ba chóir a choinneáil?',
    'dup_merge.save_btn'                          => 'Aontaigh in aon taifead amháin',
    'dup_merged'                                  => 'Tá an dá thaifead sin ina n-aon cheann anois. Tá an t-athrú ar stair an taifid atá fágtha.',
    'dup_queue.choose_table'                      => 'Roghnaigh tábla',
    'dup_queue.col_actions'                       => 'Cad le déanamh',
    'dup_queue.col_records'                       => 'Taifid',
    'dup_queue.col_score'                         => 'An chaoi a bhfuil siad cosúil',
    'dup_queue.col_table'                         => 'Tábla',
    'dup_queue.dismiss_btn'                       => 'Ní dúblach é',
    'dup_queue.dismissed'                         => 'Marcáladh an péire sin mar nach dúblach é.',
    'dup_queue.empty'                             => 'Níl aon rud ag fanacht. Scaneáil tábla chun cuardach a dhéanamh ar sheanchinn chosúla.',
    'dup_queue.gone'                              => 'Níl an athbhreithniú sin ag fanacht a thuilleadh.',
    'dup_queue.heading'                           => 'Taifid chosúla le hathbhreithniú',
    'dup_queue.intro'                             => 'Scaneáil tábla le haghaidh sraitheanna atá cosúil lena chéile cheana féin. Is féidir leat a rá go bhfuil siad difriúil, nó iad a aontú in aon taifead amháin.',
    'dup_queue.merge_btn'                         => 'Aontaigh ina aon cheann amháin',
    'dup_queue.scan_btn'                          => 'Scaneáil an tábla seo',
    'dup_queue.scan_done'                         => 'Críochnaíodh an scaneáil. Fuarthas %s péire cosúil, cuireadh %s mír nua leis an liosta.',
    'dup_queue.scan_label'                        => 'Cuardaigh taifid chosúla i',
    ...
    'moderate.dup_approved_note'                  => 'Ceadaithe. Tá sé seo anois %s%% cosúil le taifead #%s.',
    'moderate.dup_blocked'                        => 'Ní féidir a cheadú: bheadh sé seo %s%% cosúil le taifead #%s.',
    ...
    'moderate.rationale_label'                    => 'Nóta don duine a mhol seo',
    'moderate.rationale_optional'                 => 'Nóta roghnach (coinnítear ar an taifead é).',
    'moderate.rationale_placeholder'              => 'Cén fáth ar ghlac tú leis an athrú seo vagy ar dhiúltaigh tú dó',
    'moderate.rationale_will_be_sent'             => 'Iarradh ríomhphost a chur chucu. Seolfar do nóta thíos díreach mar a scríobh tú é, mar sin coinnigh an ton cineálta agus soiléir, le do thoil.',
    ...
    'moderate.tab_similar'                        => 'Taifid chosúla',
    'moderate.tab_suggestions'                    => 'Moltaí',
    ...
    // ------------------------------------------------------------------
    'appearance.add_link'                         => 'Cuir nasc leis',
    'appearance.brand_heading'                    => 'Lógó agus Slógán',
    'appearance.colors_heading'                   => 'Dathanna',
    'appearance.colors_help'                      => 'Sáraíonn Ard-Chontrást i gcónaí iad seo nuair a úsáideann duine éigin an lasc sin.',
    'appearance.custom_heading'                   => 'Naisc Shaincheaptha',
    'appearance.custom_help'                      => 'Bíodh leisce ort an oiread agus is gá duit a chur leis. Socraigh an tuismitheoir chun nasc a neamhú faoi cheannteideal eile nó faoi roghchlár ionsuite einsím mar Riarthóir. Úsáid # mar an seoladh le haghaidh ceannteidil nach bhfuil ann ach teideal.',
    'appearance.custom_label'                     => 'Lipéad',
    'appearance.custom_parent'                    => 'Tuismitheoir',
    'appearance.custom_url'                       => 'Seoladh',
    'appearance.custom_who'                       => 'Cé a fhaigheann é a fheiceáil',
    'appearance.drag'                             => 'Tarraing le do thoil chun an t-ord a athrú',
    'appearance.nav_heading'                      => 'Nascleanúint',
    'appearance.nav_help'                         => 'Is féidir leat an láimhseáil a tharraing chun na naisc ionsuite agus shaincheaptha a athordú le chéile. Chun nasc a chur faoin Riarthóir (Nó ceannteideal eile), socraigh an tuismitheoir ar an nasc sin. Cruthaíonn Seoladh # ceannteideal gan leathanach dá chuid féin. Fanann Logáil Isteach agus Próifíl ina suíomh ionsuite.',
    'appearance.new_tab'                          => 'Cluaisín nua',
    'appearance.parent_builtin'                   => 'Roghnchláir Ionsuite',
    'appearance.parent_custom'                    => 'Do Cheannteidil',
    'appearance.parent_none'                      => 'An leibhéal uachtarach — Mír Roghchláir Féin',
    'appearance.remove_link'                      => 'Bain',
    'appearance.reset'                            => 'Athshocraigh go Réamhshocrú',
    'appearance.reset_ok'                         => 'Cuma Athshocraithe go dtí an Dealramh Réamhshocraithe.',
    'appearance.save'                             => 'Sábháil Cuma',
    'appearance.saved'                            => 'Cuma Sábháilte.',
    'appearance.type_heading'                     => 'Cineál',
    ...
    'settings.cron_command_label'                 => 'Seo an t-ordú le greamú i do Phoist Cron (Déanfaidh uair sa lá an beart go maith!)',
    'settings.cron_exec_ok'                       => 'Ceadaíodh don Leathanach Seo PHP a Thástáil As Seo (Roghnach)',
    'settings.cron_maintenance_desc'              => 'Chuir pRD súil go huathoibríoch ar do fhreastalaí gréasáin agus molann sé ordú oíche. Ní mór duit é a ghreamú i do Phoist Cron fós le do thoil. Is féidir leat glantachas a rith anois freisin.',
    'settings.cron_maintenance_heading'           => 'Cothabháil Chomharthaí Uathoibrithe & Socrú Cron',
    'settings.cron_php_ok'                        => 'Orduithe PHP Aimsithe',
    'settings.cron_script_ok'                     => 'Comhghairdeachas - Tá Do Scripte Glantacháin i nÁit!',
    ...
    'settings.dup_heading'                        => 'Bainistíocht Taifead Dúblach',
    'settings.dup_help'                           => 'Déanann pRD comparáid idir an méid a clóscríobhadh agus sraitheanna eile sa tábla céanna. Is féidir leat rabhadh a thabhairt do dhaoine, stop a chur leis an sábháil, vagy é seo a mhúchadh.',
    'settings.dup_legend'                         => 'Má tá taifead nua cosúil le ceann atá agat cheana féin',
    'settings.dup_mode_block'                     => 'Ná lig dóibh sábháil',
    'settings.dup_mode_flag'                      => 'Tabhair rabhadh dóibh, agus déan nóta de do mheánadóir má shábhálann siad barántúil',
    'settings.dup_mode_off'                       => 'Ná seiceáil le haghaidh taifead cosúil',
    'settings.dup_mode_warn'                      => 'Taispeáin rabhadh — is féidir leo sábháil fós',
    'settings.dup_picky_exact'                    => 'Ach amháin nuair a bhíonn na focail ag teacht go dlúth le chéile',
    'settings.dup_picky_label'                    => 'Cé chomh déine agus ba chóir don seiceáil a bheith?',
    'settings.dup_picky_similar'                  => 'Glac le hearráidí litrithe gar freisin (litriú cosúil)',
    ...
    'settings.map_tile_api_key_help'              => 'Tá gá leis seo do CARTO, Mapbox nó Stadia. Fág folamh le do thoil chun eochair atá ann cheana a choinneáil. Ní ghá eochair don OpenStreetMap réamhshocraithe.',
    'settings.map_tile_carto'                     => 'CARTO Voyager (Eochair In Aisce Ar Fáil ó carto.com/basemaps/apikey)',
    'settings.map_tile_custom'                    => 'URL tíl saincheaptha',
    'settings.map_tile_default'                   => 'Réamhshocrú saor in aisce (OpenStreetMap)',
    ...
    'settings.mod_leaderboard_desc'               => 'Aithníonn iarrachtaí trascríobh agus coinníonn sé scór.',
    'settings.mod_leaderboard_note'               => '(Éilíonn bainistíocht úsáideoirí & rochtain ilúsáideora)',
    'settings.mod_maps'                           => 'Léarscáileanna',
    'settings.mod_maps_desc'                      => 'Taispeáin léarscáil geografach do gach tábla a bhfuil colún suímh dinimiciúil aige.',
    ...
    'settings.perm_locked'                        => 'Tá an cead seo éigeantach d\'Administraitoirí.',
    'settings.perm_more_info'                     => 'Tuilleadh faoi',
    'settings.perm_needs'                         => 'Teastaíonn uaidh',
    'settings.perm_needs_parent'                  => 'Cas air sin ar dtús, le do thoil.',
    'settings.perm_no_links'                      => 'Níl an cead seo ag brath ar cheann eile.',
    'settings.perm_save_failed'                   => 'Brón orm - Níorbh fhéidir le pRD an Suíomh Seo a Shábháil.',
    'settings.perm_saved'                         => 'Sábháilte',
    'settings.perm_swipe'                         => 'Ar scáileán beag, le do thoil scriop an liosta seo go taobhach más gá.',
    'settings.perm_used_by'                       => 'Ag teastáil ó',
    ...
    'settings.subheading'                         => 'Bainistigh Cuma, Cumraíocht Chroí, Tiománaithe Ríomhphoist, Roghanna Slándála/CAPTCHA, Modúil, Mód Cothabhála, Fógraí Suímh, agus Cumais Róil.',
    'settings.sys_name_label'                     => 'Ainm an chórais / fheidhmchláir:',
    'settings.system_guest'                       => 'Córas / Aoi',
    'settings.tab_appearance'                     => 'Cuma',
    ...
    'update_database.emergency_active'            => 'Tá rochtain nuashonraithe ar an bpunachar sonraí ar oscailt ionas gur féidir leat an chéim seo a chríochnú gan logáil isteach. Dúnfaidh sé é féin nuair a bheidh an Bunachar Sonraí cothrom le dáta.',
    'updates.already_current'                     => 'Comhrecaíonn na Comhaid leis an gCainéal Nuashonraithe Roghnaithe cheana féin. Níor athraíodh aon rud.',
    'updates.apply_btn'                           => 'Cuir Pacáiste Comhaid i bhFeidhm',
    'updates.archive_failed'                      => 'Brón orm - Níorbh fhéidir le pRD an chóip phríobháideach bhunachair sonraí a scríobh. Níor thosaigh an Nuashonrú Comhaid.',
    'updates.archive_missing'                     => 'Brón orm - níor frithadh an cúltaca príobháideach sin.',
    'updates.channel_help'                        => 'Ná athraigh an Cainéal Nuashonraithe mura Forbróir tú. Is féidir le Forbróirí Clp nó Tag nó Tag a chur sa bhosca seo.',
    'updates.channel_label'                       => 'Cainéal Nuashonraithe (Ba chóir é seo a fhágáil mar \'Main\' de ghnáth)',
    'updates.channel_saved'                       => 'Cainéal Nuashonraithe Sábháilte.',
    'updates.confirm'                             => 'An mian leat an Pacáiste Comhaid a chur i bhfeidhm anois? Ná bí buartha, fanann do chuid taifid. Íoslódáil cóip de do bhunachar sonraí ar dtús mura bhfuil sé déanta agat cheana féin.',
    'updates.db_behind'                           => 'Bunachar Sonraí: Tá Nuashonrú ag Fanacht',
    'updates.db_pending'                          => 'Má iarrann pRD ort an bunachar sonraí a nuashonrú an chéad uair eile, oscail an leathanach sin le do thoil. Ní gá duit aon chomhaid bhreise a chruthú.',
    'updates.db_ran'                              => 'Nuashonraíodh an Bunachar Sonraí freisin.',
    'updates.download_heading'                    => 'Ag íoslódáil do Bhunachar Sonraí..',
    'updates.download_please'                     => 'Íoslódáil do bhunachar sonraí ar dtús le do thoil. Coinnigh do chóip féin chomh maith le cóip phríobháideach an fhreastalaí.',
    'updates.files_behind'                        => 'Comhaid: Tá Pacáiste Níos Nua ar Fáil',
    'updates.files_current'                       => 'Comhaid: Cothrom le Dáta leis an gCainéal Nuashonraithe Roghnaithe',
    'updates.files_error'                         => 'Comhaid: Brón orm, níorbh fhéidir le pRD GitHub a sheiceáil faoi láthair. Bain triail eile as níos déanaí.',
    'updates.files_ok'                            => 'Comhghairdeachas! Pacáiste Comhaid Curtha i bhFeidhm.',
    'updates.files_unknown'                       => 'Comhaid: Gan seiceáil fós (cuir pacáiste i bhfeidhm uair amháin chun tosú ag rianú)',
    'updates.force_apply'                         => 'Athchuir Comhaid in Ionad Pé scéal é (Mura bhfuil ach rud éigin damáistithe)',
    'updates.heading'                             => 'Nuashonruithe Comhaid',
    'updates.help'                                => 'Íoslódáil do Bhunachar Sonraí ar dtis le do thoil. Coinníonn pRD cóip phríobháideach ar an bhfreastalaí freisin. Ní athraíonn Nuashonrú Comhaid taifid. Tar éis do Chomhaid a bheith nuashonraithe, bain úsáid as "Nuashonraigh bunachar sonraí" má tá leagan bunachair sonraí níos nua-aimseartha ag fanacht.',
    'updates.no_sha'                              => 'Gan Phacáiste Taifeadta fós',
    'updates.now_db'                              => 'Má tá leagan an Bhunachair Sonraí ar gcúl, bain úsáid as "Nuashonraigh bunachar sonraí" ina dhiaidh sin.',
    'updates.page_heading'                        => 'Ag Nuashonrú pRD',
    'updates.private_copies'                      => 'Cóipeanna Freastalaí Príobháideacha (Riarthóir Amháin)',
    'updates.running'                             => 'Tá an Suíomh Seo ag Rith',
    ...
    'admin_users.not_verified_badge'              => 'Gan Fíorú',
    ...
    'admin_users.reset_2fa_btn'                   => 'Múch 2FA',
    ...
    'admin_users.verified_badge'                  => 'Fíoraithe',
    ...
    'install.admin_subheading'                    => 'Is é seo an logáil isteach don suíomh Gréasáin seo (ní don bhunachar sonraí é).',
    'install.admin_username_label'                => 'Ainm úsáideora an riarthóra',
    'install.back_btn'                            => 'Ar ais',
    'install.close_alert'                         => 'Dún',
    'install.complete_desc'                       => 'Tá do shuiteáil pRD curtha ar bun anois agus tá an Suiteálaí faoi ghlas ionas nach féidir é a rith arís de thaisme.',
    'install.complete_heading'                    => 'Comhghairdeachas!',
    'install.complete_title'                      => 'Suiteáil críochnaithe',
    'install.continue_btn'                        => 'Lean ort',
    'install.db_heading'                          => 'Nasc an bhunachair sonraí',
    'install.db_hint'                             => 'Úsáid sonraí MySQL ó phainéal rialaithe d\'óstála le do thoil. Ní hé seo logáil isteach Riarthóir an tsuímh Ghréasáin (tiocfaidh sé sin ina dhiaidh sin).',
    ...
    'install.delete_folder_hint'                  => 'Ní ligfidh go leor óstach gréasáin don tSuiteálaí a fhillteán féin a scriosadh. Mura ndéanann an cnaipe aon rud, oscail bainisteoir comhad d\'óstála gréasáin nó FTP, téigh go dtí do fhillteán tionscadail pRD, agus scrios nó athainmnigh an eolaire suiteála ann.',
    ...
    'install.mod_feedback'                        => 'Aighneachtaí Aiseolais',
    'install.mod_feedback_desc'                   => 'Cumasú Foirm Aiseolais Poiblí agus Painéal Rianaithe Riaracháin.',
    'install.mod_leaderboard'                     => 'Clár Ceannairí & Gamification',
    'install.mod_leaderboard_desc'                => 'Tábla phointí roghnach. Teastaíonn go mbeadh cuntais úsáideora ar siúl.',
    ...
    'install.mod_moderation'                      => 'Sreabhadh Oibre Modhnúcháin',
    'install.mod_moderation_desc'                 => 'Córas sreafa oibre modhnúcháin a ligeann d\'úsáidters eagruithe a mholadh agus do Mhodhnóir an moladh a cheadú nó a dhiúltú.',
    'install.mod_users'                           => 'Bainistíocht Úsáideoirí & Rochtain Ilúsáideora',
    'install.mod_users_desc'                      => 'Lig do dhaoine clárú agus logáil isteach.',
    'install.mod_volunteers'                      => 'Tairseach Saorálaithe & Aighneachtaí',
    'install.mod_volunteers_desc'                 => 'Cumasú Foirm Leasa Saorálaí Poiblí agus Painéal Bainistíochta Riaracháin.',
    'install.modules_continue'                    => 'Sábháil agus lean ort',
    'install.modules_heading'                     => 'Cé na codanna de pRD a mba mhaith leat a úsáid?',
    'install.modules_help'                        => 'Seiceáil na gnéithe atá uait ón gcéad lá, le do thoil. Is féidir leat é seo a athrú níos déanaí faoi Riarachán → Socruithe Suímh.',
    'install.modules_later'                       => 'Is Féidir Leat Aon Cheann de na Modúil Seo a Chasadh Air nó As níos déanaí in Admin → Socruithe Suímh.',
    ...
    'install.msg_modules_saved'                   => 'Sábháladh do Roghanna Modúil. Is féidir leat pacáistí taispeána roghnacha a chur leis, nó an chéim seo a scipeáil más fearr leat.',
    ...
    'install.remove_already_gone'                 => 'Tá an Fillteán Suiteála bainte cheana féin.',
    'install.remove_failed'                       => 'Brón orm - Níorbh fhéidir le pRD an Fillteán Suiteála a scriosadh go huathoibríoch (is minic nach mbíonn freastalaithe gréasáin in ann). I mbainisteoir comhad d\'óstála gréasáin nó trí FTP, oscail an fillteán pRD agus scrios nó athainmnigh an eolaire suiteála taobh istigh de.',
    'install.remove_folder_btn'                   => 'Bain an fillteán suiteála le do thoil!',
    'install.remove_ok'                           => 'Baineadh an Fillteán Suiteála.',
    ...
    'footer.software_notice'                      => 'Tá pRD (V1.18) foinse oscailte faoin gCeadúnas MIT - Go raibh maith agat le @katherinehuk ar GitHub as an dara péire súl!',
    ...
    'save_data_entry.err_email'                   => 'Cuir isteach ríomhphost bailí le haghaidh %s le do thoil.',
    ...
    'save_data_entry.err_url'                     => 'Cuir isteach seoladh gréasáin a thosaíonn le http:// nó https:// le haghaidh %s le do thoil.',
    ...
    'data_entry.admin_cols_prompt'                => 'Más Riarthóir tú, téigh go Riarthóir → Bainistigh Táblaí chun colúin a bhainistiú agus colún amháin ar a laghad a chur leis an tábla seo.',
    'data_entry.admin_tables_prompt'              => 'Más Riarthóir tú, téigh go Riarthóir → Bainistigh Táblaí chun tábla a chur leis, agus ansin cuir colún amháin ar a laghad leis.',
    ...
    'data_entry.date_format_hint'                 => 'Bain úsáid as an bhformáid dáta a thaispeántar sa bhosca le do thoil.',
    ...
    'data_entry.dup_blocked'                      => 'Tá an taifead seo ró-chosúil le ceann atá sábháilte cheana féin, mar sin ní féidir é a chur leis.',
    'data_entry.dup_close_match'                  => 'Litriú an-chosúil',
    'data_entry.dup_confirm_btn'                  => 'Sea, deimhnigh agus sábháil an dúblach',
    'data_entry.dup_desc'                         => 'Seiceáil na cártaí thíos, le do thoil. Is féidir leat sábháil fós más taifead difriúil é seo.',
    'data_entry.dup_empty'                        => '(folamh)',
    'data_entry.dup_flag_btn'                     => 'Sábháil agus abair le meánadóir',
    'data_entry.dup_heading'                      => '⚠️ Rabhadh faoi dhúblach féideartha',
    'data_entry.dup_item_format'                  => 'ID an Taifid: %d — Luach: %s',
    'data_entry.dup_overview'                     => 'Sábháilte cheana féin',
    'data_entry.dup_prompt'                       => 'An mian leat leanúint ar aghaidh agus an iontráil dúblach seo a shábháil barainneach?',
    'data_entry.dup_review_btn'                   => 'Athbhreithnigh an méid a chlóscríobh mé',
    'data_entry.dup_score_exact'                  => 'Cosúlacht ríofa %s faoin gcéad.',
    'data_entry.dup_similar'                      => 'Tá sé seo %s%% cosúil le taifead #%s',
    ...
    'data_entry.go_manage_tables'                 => 'Téigh go Riarthóir → Bainistigh Táblaí le do thoil',
    ...
    'data_entry.shortcuts_tip'                    => '💡 Leideanna: Brúigh Ctrl + Enter chun a chur isteach, nó Esc chun an réimse reatha a ghlanadh.',
    ...
    'data_entry.time_format_hint'                 => 'Bain úsáid as an bhformáid ama a thaispeántar sa bhosca le do thoil.',
    ...
    'profile.setup_tfa_btn'                       => 'Socraigh 2FA',
    ...
    'setup_2fa.backup_desc'                       => 'Sábháil na cóid cúltaca seo in áit shábháilte le do thoil. Is féidir gach cód a úsáid uair amháin má chailleann tú rochtain ar d\'aip 2FA:',
    ...
    'setup_2fa.heading'                           => 'Socraigh 2FA',
    ...
    'suggest_edit.decision_accepted'              => 'Glactha',
    'suggest_edit.decision_not_accepted'          => 'Gan glacadh',
    'suggest_edit.dup_of_help'                    => 'Roghnach. Feicfidh meánadóirí an nóta seo.',
    'suggest_edit.dup_of_label'                   => 'Má tá uimhir an taifid eile ar eolas agat, is féidir leat é a chur leis anseo',
    'suggest_edit.dup_please_check'               => 'Bheadh an t-athrú seo an-chosúil le taifead eile. Seiceáil thíos, le do thoil.',
    'suggest_edit.empty_label'                    => '(folamh)',
    'suggest_edit.err_notify_email'               => 'Cuir isteach seoladh ríomhphoist más mian leat an toradh a chloisteáil, le do thoil.',
    'suggest_edit.heading_prefix'                 => 'Mol eagar don taifead',
    'suggest_edit.leave_blank'                    => 'Fág an réimse seo bán',
    'suggest_edit.no_rationale'                   => 'Níor cuireadh aon nóta breise leis.',
    'suggest_edit.notify_email_help'              => 'Úsáidtear é chun an toradh a insint duit amháin. Ní thaispeántar é ar an taifead poiblí.',
    'suggest_edit.notify_email_label'             => 'Do sheoladh ríomhphoist',
    'suggest_edit.notify_label'                   => 'Cuir ríomhphost chugam nuair a bheidh cinneadh déanta ag meánadóir',
    ...
    'suggest_edit.report_dup'                     => 'Sílim gur dúblach é an taifead seo de cheann eile',
